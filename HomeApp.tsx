...
export default function HomeApp({ articles }: HomeAppProps) {
  ...
  const handleSelectCategory = useCallback((id: string | null) => {
    ...
    setSearchQuery('')
    syncUrlQuery('')
    // FIX #65: scroll to archive so the user sees filtered results immediately.
    // This makes the "Все →" button in CategorySection (ArticlesGrid) behave
    // identically to the main category navigation on the home page.
