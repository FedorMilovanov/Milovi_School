    ...
    <div className="relative bg-[var(--bg-main)] pb-32 pt-0 lg:pb-24">
      ...
      <div className="px-4 pt-8 sm:px-6">
        <article className="mx-auto max-w-7xl">
          ...
          {/* 3-column body */}
          <div className={`grid gap-10 ${focusMode ? 'lg:grid-cols-[minmax(0,54rem)] lg:justify-center' : 'lg:grid-cols-[15rem_minmax(0,52rem)]'}`}>
            {/* Desktop sidebar */}
          ...
          {article.faq && article.faq.length > 0 && (
            ...
            {/* Spacer for right column — removed; 3rd column never populated (FIX #53) */}
