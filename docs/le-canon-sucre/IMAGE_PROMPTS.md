...
- крайние **18–20%** слева и справа считать crop-safe зоной без критических деталей: тот же source используется широким article hero и вертикальным gallery crop;
...
**Target:** `public/images/canon-sucre/hero.webp`
...
**Target:** `public/images/articles/saint-honore.webp`
...
**Target:** `public/images/articles/paris-brest.webp`
...
**Target:** `public/images/articles/baba-au-rhum.webp`
...
**Target:** `public/images/articles/genin-tarte-citron.webp`
...
**Target:** `public/images/articles/opera.webp`
...
**Target:** `public/images/articles/ispahan.webp`
...
**Target:** `public/images/articles/herme-2000-feuilles.webp`
...
**Target:** `public/images/articles/mont-blanc.webp`
...
**Target:** `public/images/articles/religieuse.webp`
...
**Target:** `public/images/articles/kouign-amann.webp`
...
**Target:** `public/images/articles/tarte-tatin.webp`
...
**Target:** `public/images/articles/tarte-tropezienne.webp`
...
**Target:** `public/images/articles/canele-bordeaux.webp`
...
**Target:** `public/images/articles/eclair.webp`
...
**Target:** `public/images/articles/galette-des-rois.webp`
...
- [ ] WebP source dimensions внесены в `src/data/articleImageDimensions.ts`;
- [ ] `npm run build && npm run audit:site` проходит после добавления файла.

## 5. Naming

Для уже существующих library images Canon использует их текущие production paths и не создаёт дубликаты. Новые dedicated assets нужны только там, где существующее изображение не соответствует точному Canon object. На текущем этапе такими обязательными новыми assets являются:

- `public/images/articles/genin-tarte-citron.webp`
- `public/images/articles/herme-2000-feuilles.webp`

Не заменять их изображениями Cédric Grolet citron или generic/Conticini/Perret mille-feuille: это другие авторские объекты и другая редакционная семантика.
