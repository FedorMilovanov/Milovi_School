...
**Статус Wave 2:** основной closeout выполнен — рэтчет `MAX_WEAK_CITATIONS` снижен 73 → 5; финальные 5 остаются явным контролируемым долгом, который нельзя увеличивать.
