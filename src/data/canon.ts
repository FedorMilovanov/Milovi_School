 ...
 *
 * gridRow/gridStart/gridSpan define the desktop exhibition composition
 * explicitly. Responsive breakpoints collapse that composition to 2 and 1
 * columns without mutating collection order.
 */
