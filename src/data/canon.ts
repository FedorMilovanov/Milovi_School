 ...
 *
 * gridStart/gridSpan define the desktop exhibition composition explicitly.
 * Responsive breakpoints collapse that composition to 2 and 1 columns.
 */
export const canonWorks: CanonWork[] = [
  {
    id: 'saint-honore', order: 1, name: 'Saint-Honoré', act: 'forme', isAnchor: true, visualTone: 'amber', gridStart: 1, gridSpan: 8,
  ...
  {
    id: 'paris-brest', order: 2, name: 'Paris-Brest', act: 'forme', visualTone: 'cocoa', gridStart: 9, gridSpan: 4,
  ...
  {
    id: 'religieuse', order: 3, name: 'Religieuse', act: 'forme', visualTone: 'cocoa', gridStart: 1, gridSpan: 4,
  ...
  {
    id: 'eclair', order: 4, name: 'Éclair', act: 'forme', visualTone: 'cream', gridStart: 5, gridSpan: 4,
  ...
  {
    id: 'opera', order: 5, name: 'Opéra', act: 'forme', visualTone: 'cocoa', gridStart: 9, gridSpan: 4,
  ...
  {
    id: 'baba-au-rhum', order: 6, name: 'Baba au Rhum', act: 'signature', visualTone: 'amber', gridStart: 1, gridSpan: 4,
  ...
  {
    id: 'tarte-au-citron', order: 7, name: 'Tarte au Citron', act: 'signature', visualTone: 'cream', gridStart: 1, gridSpan: 4,
  ...
  {
    id: 'ispahan', order: 8, name: 'Ispahan', act: 'signature', isAnchor: true, visualTone: 'rose', gridStart: 5, gridSpan: 8,
  ...
  {
    id: '2000-feuilles', order: 9, name: '2000 Feuilles', act: 'signature', visualTone: 'amber', gridStart: 5, gridSpan: 4,
  ...
  {
    id: 'mont-blanc', order: 10, name: 'Mont-Blanc', act: 'signature', visualTone: 'cocoa', gridStart: 9, gridSpan: 4,
  ...
  {
    id: 'kouign-amann', order: 11, name: 'Kouign-Amann', act: 'territoire', visualTone: 'amber', gridStart: 1, gridSpan: 4,
  ...
  {
    id: 'tarte-tatin', order: 12, name: 'Tarte Tatin', act: 'territoire', visualTone: 'amber', gridStart: 5, gridSpan: 4,
  ...
  {
    id: 'tarte-tropezienne', order: 13, name: 'Tarte Tropézienne', act: 'territoire', visualTone: 'cream', gridStart: 9, gridSpan: 4,
  ...
  {
    id: 'canele-bordeaux', order: 14, name: 'Canelé de Bordeaux', act: 'territoire', isAnchor: true, visualTone: 'copper', gridStart: 1, gridSpan: 8,
  ...
  {
    id: 'galette-des-rois', order: 15, name: 'Galette des Rois', act: 'territoire', visualTone: 'amber', gridStart: 9, gridSpan: 4,
