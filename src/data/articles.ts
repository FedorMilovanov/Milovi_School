...
export const articles: Article[] = [
  { id: 'grolet-lemon-yuzu', title: 'Рецепт знаменитого «Лимона» Седрика Гроле: Пошаговая техника иллюзорного десерта', excerpt: 'Техническая карта по культовому лимону: как сохранить кислоту, сделать тонкое покрытие и избежать вкуса варенья.', content: body('Седрик Гроле и лимон', 'grolet-lemon-yuzu'), category: 'cedric-grolet', author: 'PastryClass, Cedric Grolet references', readTime: 6, image: '/images/articles/grolet-lemon-yuzu.webp', tags: ['лимон', 'юдзу', 'ганаш', 'обманка'], sourceUrl: 'https://reportergourmet.com/en/news/7740-cedric-grolet-and-the-recipe-for-stuffed-lemon-it-looks-like-fruit-but-it-s-a-dessert', date: '2025-01-15', sourceLabel: 'Reporter Gourmet' },
  { id: 'herme-ispahan-deep', title: 'Десерт Испахан от Пьера Эрме: Рецепт архитектуры вкуса (роза, личи и малина)', excerpt: 'Полный учебный разбор культового десерта: кислота малины, цветочный верх розы, сочная середина личи.', content: body('Испахан Пьера Эрме', 'herme-ispahan-deep'), category: 'pierre-herme', author: 'PH10, Traveling Foodies, PastryClass', readTime: 3, image: '/images/articles/herme-ispahan-deep.webp', tags: ['Испахан', 'роза', 'личи', 'малина'], sourceUrl: 'https://travellingfoodies.wordpress.com/2011/03/25/pierre-hermes-ispahan/', date: '2025-01-22', sourceLabel: 'Traveling Foodies' },
  { id: 'perret-softness-volume', title: 'Перре: объем, мягкость, воздушность и хрупкость как язык десерта', excerpt: 'Проверенный разбор стиля François Perret: мягкость, объём, лёгкость и десерты Ritz Paris без неподтверждённых цитат.', content: body('Франсуа Перре', 'perret-softness-volume'), category: 'francois-perret', author: 'Ritz Paris, So Good Magazine, Books for Chefs', readTime: 2, image: '/images/articles/perret-softness-volume.webp', tags: ['мягкость', 'Ritz', 'сахар', 'текстура'], sourceUrl: 'https://www.ritzparislecomptoir.com/en/francois-perret', date: '2025-02-01', sourceLabel: 'Ritz Paris Le Comptoir' },
  ...
  { id: 'lignac-kouign-amann', title: 'Сириль Линьяк и Kouign-Amann: карамельная корка, слоёность и соль Бретани', excerpt: 'Полный технологический разбор бретонской классики: дрожжевое тесто, масло, сахар, тройной тур и финальная карамелизация в форме.', content: body('Линьяк куинь-аман', 'lignac-kouign-amann'), category: 'cyril-lignac', author: 'Cyril Lignac, David Lebovitz', readTime: 6, image: '/images/articles/lignac-kouign-amann.webp', tags: ['kouign-amann', 'Бретань', 'карамель', 'слоёность'], sourceUrl: 'https://www.davidlebovitz.com/kouign-amann/', date: '2026-04-29', sourceLabel: 'David Lebovitz' },

  // ── CLAIRE HEITZLER ─────────────────────────────────────────────────────────
  { id: 'heitzler-less-sugar', title: 'Клер Эйцлер: меньше сахара — больше вкуса. Как убрать 30% без потери удовольствия', excerpt: 'Практический разбор методологии: чем компенсировать сладость, как работает кислота, и почему горечь — это не враг.', content: body('Эйцлер меньше сахара', 'heitzler-less-sugar'), category: 'claire-heitzler', author: 'Pastry Arts Magazine, Valrhona', readTime: 6, image: '/images/articles/heitzler-less-sugar.webp', tags: ['сахар', 'баланс', 'кислота', 'горечь'], sourceUrl: 'https://www.chefs4impact.org/post/meet-claire-heitzler', date: '2026-04-30', sourceLabel: 'Pastry Arts Magazine' },
  { id: 'heitzler-floral-palette', title: 'Клер Эйцлер: цветочная палитра — жасмин, фиалка, роза в современном десерте', excerpt: 'Как работать с цветочными ароматами без синтетики: натуральные экстракты, свежие лепестки, дистилляция и точный баланс.', content: body('Эйцлер цветочная палитра', 'heitzler-floral-palette'), category: 'claire-heitzler', author: 'Madame Figaro, Pastry Arts Magazine', readTime: 5, image: '/images/articles/heitzler-floral-palette.webp', tags: ['цветы', 'жасмин', 'роза', 'аромат'], sourceUrl: 'https://www.chefs4impact.org/post/meet-claire-heitzler', date: '2026-05-01', sourceLabel: 'Madame Figaro' },

  // ── CHRISTOPHE FELDER ────────────────────────────────────────────────────────
  { id: 'felder-fraisier', title: 'Фрезье Фельдера: классика, которую надо понять до автоматизма', excerpt: 'Пошаговый учебный разбор знакового торта: génoise, crème mousseline, сироп понч, клубника и финальная отделка марципаном.', content: body('Фельдер фрезье', 'felder-fraisier'), category: 'christophe-felder', author: 'Christophe Felder, Patisserie book', readTime: 7, image: '/images/articles/felder-fraisier.webp', tags: ['фрезье', 'генуаз', 'муссилин', 'клубника'], sourceUrl: 'https://headbutler.com/reviews/patisserie-mastering-the-fundamentals-of-french-pastry/', date: '2026-05-02', sourceLabel: 'Patisserie — Felder' },
  { id: 'felder-biscuit-joconde', title: 'Бисквит «Жоконда» по Фельдеру: структура, техника и рулет Opera', excerpt: 'Почему бисквит «Жоконда» — это не просто тесто, а архитектурный элемент энтреме: миндаль, протеин белка и рулет Опера.', content: body('Фельдер бисквит жоконда', 'felder-biscuit-joconde'), category: 'christophe-felder', author: 'Christophe Felder, Patisserie book', readTime: 6, image: '/images/articles/felder-biscuit-joconde.webp', tags: ['жоконда', 'Опера', 'бисквит', 'миндаль'], sourceUrl: 'https://headbutler.com/reviews/patisserie-mastering-the-fundamentals-of-french-pastry/', date: '2026-05-03', sourceLabel: 'Patisserie — Felder' },

  // ── NICOLAS PACIELLO ─────────────────────────────────────────────────────────
  { id: 'paciello-flan-parisien', title: 'Николя Пачелло: flan parisien — философия простоты и техника без права на ошибку', excerpt: 'Почему главный кондитер Plaza Athénée посвятил парижскому флану отдельную страницу в меню: тесто, крем, температура.', content: body('Пачелло флан парижский', 'paciello-flan-parisien'), category: 'nicolas-paciello', author: 'Frenchefs, Journal des Femmes', readTime: 6, image: '/images/articles/paciello-flan-parisien.webp', tags: ['флан', 'Париж', 'простота', 'Plaza Athénée'], sourceUrl: 'https://frenchefs.fr/nicolas-paciello', date: '2026-05-04', sourceLabel: 'Frenchefs' },
  { id: 'paciello-praline-art', title: 'Пачелло: пралине как художественный жест — ореховая база, текстура и точность', excerpt: 'Как шеф-кондитер CinqSens работает с пралине: три сорта фундука, карамельные степени, гранулометрия и правило «вкус из сырья».', content: body('Пачелло пралине искусство', 'paciello-praline-art'), category: 'nicolas-paciello', author: 'Frenchefs, So Good Magazine', readTime: 5, image: '/images/articles/paciello-praline-art.webp', tags: ['пралине', 'фундук', 'карамель', 'CinqSens'], sourceUrl: 'https://frenchefs.fr/nicolas-paciello', date: '2025-01-15', sourceLabel: 'Meilleur du Chef' },

  // ── НОВЫЕ СТАТЬИ (до 4 в каждой категории) ────────────────────────────────

  { id: 'michalak-biography', title: 'Кристоф Мишалак: чемпион мира, Plaza Athénée и принцип щедрого десерта', excerpt: 'Биография: Санлис, CAP, 11 лет в Plaza Athénée, победа на Coupe du Monde 2005 и открытие Masterclass.', content: body('Мишалак биография', 'michalak-biography'), category: 'christophe-michalak', author: 'Le Figaro, Reporter Gourmet', readTime: 5, image: '/images/articles/michalak-biography.webp', tags: ['биография', 'чемпион мира', 'Plaza Athénée', 'Fantastik'], sourceUrl: 'https://reportergourmet.com/en/chef/782-christophe-michalak', date: '2025-01-22', sourceLabel: 'Reporter Gourmet' },

  { id: 'ansel-cronut', title: 'Ансель после Cronut: токийская лаборатория, концепция невозможного десерта и эволюция', excerpt: 'Что Доминик Ансель придумал после того, как Cronut стал иконой: японский минимализм, физика мороженого и теория «мгновения» в современной пекарне.', content: body('Ансель Cronut', 'ansel-cronut'), category: 'dominique-ansel', author: 'The New York Times, Food52, Dominique Ansel Bakery', readTime: 6, image: '/images/articles/ansel-cronut.webp', tags: ['Токио', 'инновация', 'концепция', 'эволюция'], sourceUrl: 'https://dominiqueanselbakery.com', date: '2025-02-01', sourceLabel: 'Dominique Ansel Bakery' },
