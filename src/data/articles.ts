...
export const articles: Article[] = [
  ...
  { id: 'metayer-biography', title: "Нина Метайе: FERRANDI, Ladurée, World Pastry Chef 2023", excerpt: 'Биография лучшего кондитера мира: от Ниора до Мюнхена и Лас-Вегаса — через трёхзвёздочный Реймс, Fauchon, Le Meurice и 14 лет найма.', content: body('Метайе биография', 'metayer-biography'), category: 'nina-metayer', author: "World's 50 Best, Le Monde", readTime: 3, image: '/images/articles/metayer-biography.webp', tags: ['биография', 'World\'s Best', 'FERRANDI', 'Ladurée'], sourceUrl: 'https://www.theworlds50best.com/stories/News/nina-metayer-worlds-best-pastry-chef-2023.html', date: '2025-02-20', sourceLabel: "World's 50 Best", updatedAt: '2026-09-16' },
...

  {
    ...
    date: '2026-07-08',
    sourceUrl: 'https://chefsimon.com/recettes/tag/gaufre',
    sourceLabel: 'Chef Simon',
    recipeData: {
