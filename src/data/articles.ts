...
export const articles: Article[] = [
  ...
  { id: 'grolet-raspberry-rose', title: 'Raspberry Rose от Гроле: ягода, которую только что сорвали', excerpt: 'Полная сборка фирменной малины Гроле: ванильный ганаш, малиновый гель без блендера, песочное тесто, финансье и эффект влажной кожуры.', content: `**Примечание о формате**
...
Магия Гроле здесь не в форме, а в технике геля без блендера. Это самый недооценённый шаг, и именно он отличает любительскую копию от ресторанного оригинала.`, category: 'cedric-grolet', author: 'PastryClass, Cedric Grolet references', readTime: 2, image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=800', tags: ['малина', 'ваниль', 'ганаш', 'обманка', 'велюр'], sourceUrl: 'https://mypastryclass.com/blogs/articles/cedric-grolet-teaches-fruits-nuts-and-flowers', date: '2025-06-01', sourceLabel: 'PastryClass' },
  ...
  { id: 'recipe-pecan-chocolate-creme-brulee', title: "Entremets «Пекан, шоколад и крем-брюле»: рецепт от Ogre de Carrouselberg", excerpt: 'Полная технологическая карта мини-тарт от лилльского кондитера: пралине из пекана, ганаш-монте, шоколадный бисквит и крем-брюле как вставка.', content: `**Примечание о формате**
...
Главная мысль: текстурный контраст работает только при правильной температуре подачи. Замороженная вставка должна успеть оттаять до кремовой текстуры, ганаш должен быть мягким, хруст должен оставаться сухим. Окно для сервиса — 15-20 минут после демолдирования.`, category: 'recipes', author: 'Fou de Pâtisserie, Ogre de Carrouselberg, defis-patisserie.com', readTime: 7, image: localImages.pecan, tags: ['рецепт', 'пекан', 'шоколад', 'крем-брюле', 'entremets'], sourceUrl: 'https://defis-patisserie.com/decouvrez-lentremets-noix-de-pecans-chocolat-et-creme-brulee/', date: '2024-11-01', sourceLabel: 'defis-patisserie.com' },
  ...
  { id: 'stohrer-1730', title: 'Maison Stohrer 1730: старейшая кондитерская Парижа, пережившая Наполеона, революцию и две войны', excerpt: 'Николас Шторер — кондитер польского короля — открыл лавку на Rue Montorgueil в 1730 году. Там же она стоит до сих пор. История баба-о-рома, puits d\'amour и religieuse.', content: `================================================
...
Сейчас лавкой владеет Сержио Нариньяни. Рецепты не изменились. Баба выпекается ежедневно, пропитывается ромом перед подачей. Туристы стоят в очереди на Rue Montorgueil так же, как стояли при Людовике XV.`, category: 'histoire-culinaire', author: 'stohrer.fr, The Parisian Guide, France Today', readTime: 2, image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800', tags: ['Stohrer', 'история', 'баба-о-ром', '1730', 'Rue Montorgueil'], sourceUrl: 'https://stohrer.fr/about-us/', date: '2023-10-01', sourceLabel: 'Maison Stohrer' },

  { id: 'laduree-1862', title: 'Ladurée 1862: как пожар, женщина с идеей и внук с кремом создали символ Парижа', excerpt: 'Луи-Эрнест Ладюрэ открыл булочную в 1862 году. Пожар уничтожил её — он перестроил в кондитерскую. Жена добавила чайный салон. Внук склеил два печенья кремом. Родился парижский макарон.', content: `================================================
...
Сегодня Ladurée работает в 25 странах. По данным самого бренда, ежедневно продаётся более 15 000 макаронов. Коробки Ladurée стали сувениром номер один из Парижа — вместе с открыткой Эйфелевой башни.`, category: 'histoire-culinaire', author: 'Wikipedia, Paris.zagranitsa.com', readTime: 2, image: 'https://images.unsplash.com/photo-1520218823717-f6e0b8a89d70?w=800', tags: ['Ladurée', 'макарон', 'история', '1862', 'Пьер Эрме'], sourceUrl: 'https://en.wikipedia.org/wiki/Laduree', date: '2023-11-01', sourceLabel: 'Wikipedia' },

  { id: 'careme-first-celebrity-chef', title: 'Антонен Карем: первый звёздный шеф, который кормил Наполеона', excerpt: 'Брошенный ребёнок из Парижа — и кондитер Наполеона, Александра I и принца-регента Англии. История о том, как 15-летний беспризорник стал «королём шефов», изобрёл мать-соусы и превратил кондитерское дело в архитектуру.', content: `================================================
...
Настоящий круассан au beurre ручной работы — с 27–72 слоями теста, сделанный из несолёного масла минимум 84% жирности — остаётся стандартом boulangerie artisanale. Он стоит в 2–3 раза дороже промышленного аналога.`, category: 'histoire-culinaire', author: 'ICE, Taste and Travel, Sortir à Paris', readTime: 2, image: 'https://images.unsplash.com/photo-1549090702-3a93a0b26e35?w=800', tags: ['круассан', 'история', 'ламинирование', 'венуазри', 'Август Занг'], sourceUrl: 'https://www.ice.edu/blog/brief-history-croissant-austrian-kipferl-layered-french-luxury', date: '2023-01-15', sourceLabel: 'ICE Culinary School' },
