...
export const articles: Article[] = [
  ...
  { id: 'conticini-praline', title: 'Пралине Контисини: орехи, сироп 116–118°C и карамелизация', excerpt: 'Проверенная формула Philippe Conticini: 300 г фундука, 300 г миндаля, 400 г сахара, 100 г воды и стадия sablage.', content: body('Филипп Контисини', 'conticini-praline'), category: 'philippe-conticini', author: 'Philippe Conticini, Meilleur du Chef', readTime: 5, image: '/images/articles/conticini-praline.webp', tags: ['пралине', 'осмос', 'фундук'], sourceUrl: 'https://www.meilleurduchef.com/fr/recette/praline-maison.html', date: '2025-04-10', updatedAt: '2026-09-16', sourceLabel: 'Meilleur du Chef' },
  { id: 'crookie-conticini', title: 'Crookie: от Maison Louvard до мирового тренда', excerpt: 'Документированная история Stéphane Louvard, повторной выпечки круассана с cookie dough и вирусного распространения продукта.', content: body('Crookie Maison Louvard', 'crookie-conticini'), category: 'french-cuisine', author: 'BBC Travel, AFP, Maison Louvard', readTime: 5, image: '/images/articles/crookie-conticini.webp', tags: ['Crookie', 'Лувар', 'тренды', '2024'], sourceUrl: 'https://www.bbc.com/travel/article/20240305-the-surprisingly-complicated-history-of-the-croissant', date: '2025-04-20', sourceLabel: 'BBC Travel — crookie and croissant history' },
  ...
  { id: 'recipe-pecan-chocolate-creme-brulee', title: 'Entremets «пекан, шоколад и крем-брюле»: профессиональная учебная технология', excerpt: 'Пралине пекан, шоколадный biscuit, insert крем-брюле и ганаш montée на открытых профессиональных базах без ложной авторской атрибуции.', content: body('recipe-pecan-chocolate-creme-brulee', 'recipe-pecan-chocolate-creme-brulee'), category: 'recipes', author: 'Cacao Barry, Valrhona', readTime: 4, image: localImages.pecan, tags: ['рецепт', 'пекан', 'шоколад', 'крем-брюле', 'entremets'], sourceUrl: 'https://www.cacao-barry.com/fr-FR/le-guide-des-recettes', date: '2024-11-01', sourceLabel: 'Cacao Barry — Le Guide des Recettes' },
  { id: 'tech-macaronage', title: 'Техника макаронаж: искусство идеального теста для макарон', excerpt: 'Секреты складывания теста: сбор и переворачивание, тест с лентой, проверка поверхности.', content: body('Макаронаж', 'tech-macaronage'), category: 'techniques', author: 'Pastry Expertise', readTime: 4, image: '/images/articles/tech-macaronage.webp', tags: ['макаронаж', 'макарон', 'техника'], sourceUrl: 'https://ecoledepatisserie-boutique.com/fr-us/blogs/patisserie-conseil-professionnel/preparation-cap-patisserie', date: '2024-11-15', updatedAt: '2026-09-16', sourceLabel: 'CAP pastry notes' },
  ...
  { id: 'genin-autodidact', title: 'Жак Жени: независимый путь шоколатье и кондитера', excerpt: 'Документируемый профессиональный путь, свежие ганаши, карамель и мильфей без сенсационной неподтверждённой легенды.', content: body('Жак Жени путь', 'genin-autodidact'), category: 'jacques-genin', author: 'Jacques Genin, Académie du Goût', readTime: 4, image: '/images/articles/genin-autodidact.webp', tags: ['биография', 'автодидакт', 'шоколад', 'Марэ'], sourceUrl: 'https://www.academiedugout.fr/chefs/jacques-genin_204374', date: '2024-06-15', updatedAt: '2026-09-16', sourceLabel: 'Académie du Goût — Jacques Genin' },

  { id: 'genin-millefeuille', title: 'Мильфей Жани: «К 14:00 или к 20:00?» — почему сборка решает всё', excerpt: 'Почему лучший мильфей Парижа не продаётся утром: философия свежести, феноменальные карамели и то, чему Жени научился у ресторанных шефов.', content: body('Жак Жени мильфей', 'genin-millefeuille'), category: 'jacques-genin', author: 'Paris by Mouth, The Wandering Eater, L\'Honoré', readTime: 3, image: '/images/articles/genin-millefeuille.webp', tags: ['мильфей', 'карамель', 'freshness', 'Париж'], sourceUrl: 'https://parisbymouth.com/our-guide-to-paris-jacques-genin/', date: '2024-07-01', updatedAt: '2026-09-16', sourceLabel: 'Paris by Mouth' },

  { id: 'herme-architecture-taste', title: 'Эрме в Гарварде: лекция об архитектуре вкуса, соль и Испахан', excerpt: 'Как четвёртое поколение кондитеров из Эльзаса превратило соль в инструмент баланса, а болгарская розовая трапеза 1987 года создала главный десерт эпохи.', content: body('Эрме архитектура вкуса', 'herme-architecture-taste'), category: 'pierre-herme', author: 'The Talks, Michelin Guide, La Liste', readTime: 3, image: '/images/articles/herme-architecture-taste.webp', tags: ['Испахан', 'соль', 'вкус', 'Гарвард', 'архитектура'], sourceUrl: 'https://the-talks.com/interview/pierre-herme/', date: '2024-07-15', updatedAt: '2026-09-16', sourceLabel: 'The Talks' },
  ...
  // ── CYRIL LIGNAC ─────────────────────────────────────────────────────────────
  { id: 'lignac-far-breton', title: 'Сириль Линьяк: фар бретон — деревенский десерт с точностью haute pâtisserie', excerpt: 'Учебный разбор фар бретон: соотношение яиц, молока и муки, сухофрукты, температура и зачем нужен высокий бортик формы.', content: body('Линьяк фар бретон', 'lignac-far-breton'), category: 'cyril-lignac', author: 'Cuisine Actuelle (архив), Académie du Goût', readTime: 5, image: '/images/articles/lignac-far-breton.webp', tags: ['фар бретон', 'Бретань', 'яйца', 'простота'], sourceUrl: 'https://app.samsungfood.com/recipes/101d76a937ad60d50ed436929a21fabd0ced42235aa', date: '2026-04-28', updatedAt: '2026-09-16', sourceLabel: 'Cuisine Actuelle — архивная карточка через Samsung Food' },
  { id: 'lignac-kouign-amann', title: 'Сириль Линьяк и Kouign-Amann: карамельная корка, слоёность и соль Бретани', excerpt: 'Полный технологический разбор бретонской классики: дрожжевое тесто, масло, сахар, туры и финальная карамелизация в форме.', content: body('Линьяк куинь-аман', 'lignac-kouign-amann'), category: 'cyril-lignac', author: 'Cyril Lignac, M6', readTime: 3, image: '/images/articles/lignac-kouign-amann.webp', tags: ['kouign-amann', 'Бретань', 'карамель', 'слоёность'], sourceUrl: 'https://actu.m6.fr/divertissement/le-meilleur-patissier-100-bretagne-tout-savoir-sur-lemission-diffusee-ce-jeudi-16-octobre-2025-m6', date: '2026-04-29', updatedAt: '2026-09-16', sourceLabel: 'M6 — Le Meilleur Pâtissier 100% Bretagne' },

  // ── CLAIRE HEITZLER ─────────────────────────────────────────────────────────
  { id: 'heitzler-less-sugar', title: 'Клер Эйцлер: меньше сахара — больше вкуса. Как убрать 30% без потери удовольствия', excerpt: 'Практический разбор методологии: чем компенсировать сладость, как работает кислота, и почему горечь — это не враг.', content: body('Эйцлер меньше сахара', 'heitzler-less-sugar'), category: 'claire-heitzler', author: 'Pastry Arts Magazine, Valrhona', readTime: 5, image: '/images/articles/heitzler-less-sugar.webp', tags: ['сахар', 'баланс', 'кислота', 'горечь'], sourceUrl: 'https://www.chefs4impact.org/post/meet-claire-heitzler', date: '2026-04-30', updatedAt: '2026-09-16', sourceLabel: 'Pastry Arts Magazine' },
  ...
  { id: 'michalak-biography', title: 'Кристоф Мишалак: чемпион мира, Plaza Athénée и принцип щедрого десерта', excerpt: 'Биография: Санлис, CAP, 11 лет в Plaza Athénée, победа на Coupe du Monde 2005 и открытие Masterclass.', content: body('Мишалак биография', 'michalak-biography'), category: 'christophe-michalak', author: 'Le Figaro, Reporter Gourmet', readTime: 3, image: '/images/articles/michalak-biography.webp', tags: ['биография', 'чемпион мира', 'Plaza Athénée', 'Fantastik'], sourceUrl: 'https://reportergourmet.com/en/chef/782-christophe-michalak', date: '2025-01-22', updatedAt: '2026-09-16', sourceLabel: 'Reporter Gourmet' },

  { id: 'ansel-cronut', title: 'Ансель после Cronut: токийская лаборатория, концепция невозможного десерта и эволюция', excerpt: 'Что Доминик Ансель придумал после того, как Cronut стал иконой: японский минимализм, физика мороженого и теория «мгновения» в современной пекарне.', content: body('Ансель Cronut', 'ansel-cronut'), category: 'dominique-ansel', author: 'The New York Times, Food52, Dominique Ansel Bakery', readTime: 5, image: '/images/articles/ansel-cronut.webp', tags: ['Токио', 'инновация', 'концепция', 'эволюция'], sourceUrl: 'https://www.dominiqueansel.com/the-creations/', date: '2025-02-01', sourceLabel: 'Dominique Ansel — The Creations' },
  ...
  { id: 'metayer-biography', title: "Нина Метайе: FERRANDI, Ladurée, World Pastry Chef 2023", excerpt: 'Биография лучшего кондитера мира: от Ниора до Мюнхена и Лас-Вегаса — через трёхзвёздочный Реймс, Fauchon, Le Meurice и 14 лет найма.', content: body('Метайе биография', 'metayer-biography'), category: 'nina-metayer', author: "World's 50 Best, Le Monde", readTime: 3, image: '/images/articles/metayer-biography.webp', tags: ['биография', 'World\'s Best', 'FERRANDI', 'Ladurée'], sourceUrl: 'https://ninametayer.com/cheffe-patissiere/', date: '2025-02-20', sourceLabel: 'Nina Métayer — biographie officielle', updatedAt: '2026-09-16' },

  { id: 'conticini-paris-brest', title: 'Контисини: верин, эмоция и La Table d\'Anvers — революция, которую не заметили', excerpt: 'Как в 1994 году Контисини переизобрёл формат десерта в стеклянном стакане, заложил философию «вкусовой памяти» и сформировал целое поколение французских кондитеров.', content: body('Контисини Париж-Брест', 'conticini-paris-brest'), category: 'philippe-conticini', author: 'Le Monde, Gault&Millau, Omnivore', readTime: 5, image: '/images/articles/conticini-paris-brest.webp', tags: ['верин', 'La Table d\'Anvers', 'философия', 'эмоция', 'история'], sourceUrl: 'https://fr.gaultmillau.com/en/news/philippe-conticini-en-5-desserts', date: '2025-03-01', updatedAt: '2026-09-16', sourceLabel: 'Gault&Millau' },

  { id: 'recipe-canele', title: 'Канеле де Бордо: медные формы, пчелиный воск и двухэтапная выпечка', excerpt: 'Полная технологическая карта бордоского канеле: выдержка теста 48 часов, температурный шок, почти горелая корочка и заварная середина.', content: body('Канеле Бордо', 'recipe-canele'), category: 'recipes', author: 'Confrérie du Canelé, Baillardran', readTime: 4, image: '/images/articles/recipe-canele.webp', tags: ['канеле', 'Бордо', 'ром', 'медные формы'], sourceUrl: 'https://www.baillardran.com/fr/content/7-l-histoire-du-canele', date: '2025-03-10', sourceLabel: 'Baillardran — histoire du canelé' },

  { id: 'couvreur-biography', title: 'Янн Куврер: Реймс, Ferrandi, мильфей à la minute и улица Мартир', excerpt: 'Биография: от кондитерского ученика в Реймсе до шефа Le Meurice и владельца трёх бутиков. История о feuilletage и независимости.', content: body('Куврер биография', 'couvreur-biography'), category: 'yann-couvreur', author: 'Gault&Millau, Le Figaro', readTime: 3, image: '/images/articles/couvreur-biography.webp', tags: ['биография', 'мильфей', 'feuilletage', 'Ferrandi'], sourceUrl: 'https://fr.gaultmillau.com/fr/news/yann-couvreur-en-5-patisseries', date: '2025-03-20', updatedAt: '2026-09-16', sourceLabel: 'Gault&Millau' },
  ...
  // ── Chiffres Gourmands ────────────────────────────────────────────────────
  {
    ...
    title: 'Французская boulangerie-pâtisserie в цифрах: что действительно показывает INSEE',
    excerpt: 'Сопоставимые данные INSEE по кодам 1071C и 1071D: предприятия, магазины, оборот и границы статистики без рекламных оценок.',
    content: body('Рынок французской кондитерской 15 млрд', 'chiffres-marche-15mlrd'),
    category: 'chiffres-gourmands',
    author: 'INSEE, Agreste',
    readTime: 5,
    image: '/images/articles/chiffres-marche-15mlrd.webp',
    tags: ['рынок', 'экономика', 'статистика', '15 млрд', 'tarte au citron', 'круассан'],
    date: '2026-05-05',
    sourceUrl: 'https://www.insee.fr/fr/statistiques/7929127',
    sourceLabel: 'INSEE — secteur 1071C, données 2021',
  },
  {
    id: 'chiffres-macarons-laduree-herme',
    title: 'Ladurée и Pierre Hermé: проверяемая экономика macaron без мифических оборотов',
    excerpt: 'Официальные цены, ассортимент, хранение, упаковка и логистика двух люксовых домов без выдуманных продаж и маржинальности.',
    content: body('Империи макаронов Ladurée Hermé', 'chiffres-macarons-laduree-herme'),
    category: 'chiffres-gourmands',
    author: 'Maison Ladurée, Maison Pierre Hermé Paris',
    readTime: 5,
    image: '/images/articles/chiffres-macarons-laduree-herme.webp',
    tags: ['макароны', 'Ladurée', 'Pierre Hermé', 'экономика', 'маржа', 'люкс'],
    date: '2026-05-05',
    sourceUrl: 'https://www.pierreherme.com/fr/macarons/coffrets-collection/coffret-de-12-macarons.html',
    sourceLabel: 'Pierre Hermé — coffret de 12 macarons',
  },
  {
    id: 'chiffres-education-mof',
    title: 'CAP, apprentissage и MOF: как устроено кондитерское образование во Франции',
    excerpt: 'Государственный référentiel CAP, 14 недель практики, официальная сетка оплаты apprenticeship и отдельный конкурсный статус MOF.',
    content: body('Образование кондитеров MOF', 'chiffres-education-mof'),
    category: 'chiffres-gourmands',
    author: 'Éduscol, Service-Public, Ministère du Travail, Société nationale des MOF',
    readTime: 5,
    image: '/images/articles/chiffres-education-mof.webp',
    tags: ['образование', 'MOF', 'Le Cordon Bleu', 'Ferrandi', 'CAP', 'apprentissage', 'карьера'],
    date: '2026-05-06',
    sourceUrl: 'https://referentiels-professionnels.eduscol.education.fr/cap_patis.html',
    sourceLabel: 'Éduscol — référentiel CAP Pâtissier',
  },
  {
    id: 'chiffres-luxury-desserts',
    title: 'Цены французской haute pâtisserie: проверяемый срез официальных витрин 2026',
    excerpt: 'Датированный срез Pierre Hermé и Ritz Paris Le Comptoir: формат, цена и условия хранения без фальшивого рейтинга и маржинальности.',
    content: body('Топ-15 дорогих десертов Франции', 'chiffres-luxury-desserts'),
    category: 'chiffres-gourmands',
    author: 'Maison Pierre Hermé Paris, Ritz Paris Le Comptoir',
    readTime: 5,
    image: '/images/articles/chiffres-luxury-desserts.webp',
    tags: ['люкс', "trompe-l'œil", 'Cédric Grolet', 'showpiece', 'palace', 'маржа', 'цены'],
    date: '2026-05-06',
    sourceUrl: 'https://www.pierreherme.com/fr/patisseries/ispahan-entremets.html',
    sourceLabel: 'Pierre Hermé — Ispahan',
  },
  {
    id: 'chiffres-anatomie-gateau',
    title: 'Анатомия французского entremets: функции слоёв, влага и температура',
    excerpt: 'Biscuit, insert, mousse, croustillant и покрытие как единая технологическая система без выдуманных «идеальных процентов».',
    content: body('Анатомия французского торта', 'chiffres-anatomie-gateau'),
    category: 'chiffres-gourmands',
    author: 'FERRANDI Paris, Cacao Barry, Valrhona',
    readTime: 5,
    image: '/images/articles/chiffres-anatomie-gateau.webp',
    tags: ['entremets', 'tarte', 'fraisier', 'архитектура', 'текстуры', 'статистика', 'рецепты'],
    date: '2026-05-06',
    sourceUrl: 'https://www.ferrandi-paris.com/fr/nos-ouvrages/patisserie/livre-recettes-et-techniques-patisserie',
    sourceLabel: 'FERRANDI Paris — Pâtisserie',
  },
...

  {
    ...
    date: '2026-06-28',
    sourceUrl: 'https://www.meilleurduchef.com/fr/recette/dacquoise-pistache.html',
    sourceLabel: 'Meilleur du Chef',
    recipeData: {
  ...
  {
    id: 'recipe-buche-noel',
    title: 'Бюш де ноэль: рецепт рулета и современного энтрме',
    excerpt: 'Бюш де ноэль: рецепт классического рулета на бисквите с кремом и современного энтрме с муссом и глазурью. Техника рулета без трещин, декор и разбор ошибок.',
    content: body('Бюш де ноэль: рецепт рулета и современно', 'recipe-buche-noel'),
    category: 'recipes',
    author: 'Mercotte, Meilleur du Chef, Chef Simon, Valrhona',
    readTime: 7,
    image: '/images/articles/recipe-buche-noel.webp',
    tags: ['бюш де ноэль', 'bûche de noël', 'рождественское полено', 'бисквит роле', 'масляный крем', 'энтрме'],
    date: '2026-06-12',
    sourceUrl: 'https://www.meilleurduchef.com/fr/recette/buche-de-noel-au-chocolat.html',
    sourceLabel: 'Mercotte',
    recipeData: {
      prepTime: 'PT1H', cookTime: 'PT12M', yield: '1 бюш 25 см / 6-8 порций',
      ingredients: ['яйца 4 шт', 'сахар 100 г', 'мука 80 г', 'какао-порошок 20 г', 'яичные желтки 5 шт', 'сахар для сиропа 150 г', 'вода 50 г', 'сливочное масло 200 г', 'ром 1 ст. л.']
    },
    faq: [
      { question: 'Почему бисквит для бюша трескается при сворачивании?', answer: 'Чаще всего из-за пересушки: передержанный в духовке бисквит ломается. Пеките 8-12 минут, сворачивайте тёплым (не горячим и не холодным) во влажном полотенце и пропитывайте сиропом.' },
      { question: 'Какой крем выбрать — масляный или ганаш монте?', answer: 'Классика — crème au beurre на сиропе 118°C: стабильна, держит форму и готовится накануне. Ганаш монте (1/3 шоколада, 2/3 сливок) легче и современнее; Valrhona советует именно её.' },
      { question: 'Можно ли приготовить бюш заранее?', answer: 'Да. Рулет хранится в холоде сутки, а энтрме-бюш собирают и замораживают за 3 недели или месяц (Mercotte, Valrhona), оставляя на день только глазировку и декор.' }
    ]
  },

  {
    id: 'recipe-chausson-aux-pommes',
    title: 'Шоссон о пом: французский слоёный пирожок с яблоком',
    excerpt: 'Шоссон о пом — французский пирожок из слоёного теста с яблочным компотом. История из Сан-Кале, формовка полумесяцем, золочение, разрезы и разбор ошибок.',
    content: body('Шоссон о пом: французский слоёный пирожо', 'recipe-chausson-aux-pommes'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Académie du Goût (Mercotte), Wikipédia',
    readTime: 8,
    image: '/images/articles/recipe-chausson-aux-pommes.webp',
    tags: ['шоссон', 'шоссон о пом', 'слоёное тесто', 'яблочный компот', 'французская выпечка', 'pâte feuilletée'],
    date: '2026-06-17',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/chaussons-aux-pommes--5',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT45M', cookTime: 'PT25M', yield: '6-8 шоссонов',
      ingredients: ['Слоёное тесто (pâte feuilletée pur beurre) 500 г', 'Яблоки reinette или golden 800 г', 'Сахар 70 г', 'Сливочное масло 25 г', 'Лимонный сок 1/2 лимона', 'Ваниль 1/2 стручка', 'Корица щепотка', 'Яйцо для золочения 1 шт', 'Соль щепотка']
    },
    faq: [
      { question: 'Почему выпечка называется «шоссон»?', answer: 'Chausson по-французски значит «тапок». С XVIII века так называют изделия, которые из круга складывают полумесяцем, будто «обувая» начинку в тесто. Складки и разрезы на нём напоминают старинные штаны-шоссы (chausses).' },
      { question: 'Почему шоссон раскрывается при выпечке?', answer: 'Из-за плохо запечатанных краёв и давления пара изнутри. Начинку кладут холодной и понемногу, воздух выгоняют, края прижимают вилкой и делают маленькое отверстие-cheminée для выхода пара.' },
      { question: 'Как избежать сырого дна?', answer: 'Компот должен быть густым (сухим) и полностью холодным. Горячая начинка топит масло в тесте и мешает слоению; перед сборкой компот выдерживают в холодильнике.' }
    ]
  },

  {
    id: 'recipe-pain-au-chocolat',
    title: 'Пан о шокола (chocolatine): слоёная булочка с шоколадом',
    excerpt: 'Пан о шокола (pain au chocolat) — французская viennoiserie из дрожжевого слоёного теста. Детрамп, тураж, шоколадные бруски, расстойка и выпечка по-французски.',
    content: body('Пан о шокола (chocolatine): слоёная було', 'recipe-pain-au-chocolat'),
    category: 'recipes',
    author: 'Meilleur du Chef, Chef Simon, Academie du Gout, Wikipedia',
    readTime: 7,
    image: '/images/articles/recipe-pain-au-chocolat.webp',
    tags: ['пан о шокола', 'pain au chocolat', 'шоколатин', 'виеннуазери', 'слоёное дрожжевое тесто', 'тураж'],
    date: '2026-06-22',
    sourceUrl: 'https://www.meilleurduchef.com/fr/recette/pain-au-chocolat-facile.html',
    sourceLabel: 'Meilleur du Chef',
    recipeData: {
      prepTime: 'PT4H', cookTime: 'PT18M', yield: '8-10 пан о шокола',
      ingredients: ['Мука T45 — 250 г', 'Мука T55 — 250 г', 'Соль — 10 г', 'Сахар — 50 г', 'Свежие дрожжи — 25 г', 'Тёплое молоко — 150 мл', 'Тёплая вода — 100 мл', 'Яйцо — 1 шт', 'Масло в тесто — 50 г', 'Масло для туража (beurre de tourage) — 250 г', 'Шоколадные бруски 44% — 16 шт', 'Яйцо для дорюр — 1 шт']
    },
    faq: [
      { question: 'Пан о шокола и шоколатин (chocolatine) — это одно и то же?', answer: 'Да. Это два региональных названия одной viennoiserie: на юго-западе Франции говорят chocolatine, в остальной стране — pain au chocolat.' },
      { question: 'Какое тесто нужно для пан о шокола?', answer: 'Дрожжевое слоёное — pate levee feuilletee (PLF), а не обычное бездрожжевое слоёное. Оно сочетает дрожжевую основу и тураж со сливочным маслом.' },
      { question: 'Почему масло вытекает при выпечке?', answer: 'Масло растопилось во время туража (тесто было теплее 20°C) или не соблюдены паузы охлаждения. Тесто и масло должны быть одинаково холодными и пластичными.' }
    ]
  },

  {
    id: 'recipe-nougat-montelimar',
    title: 'Нуга де Монтелимар: белая нуга Прованса на меду',
    excerpt: 'Нуга де Монтелимар (nougat de Montelimar) — белая нуга Прованса из лавандового мёда, взбитых белков и не менее 30% миндаля. Рецептура, температуры варки и ошибки.',
    content: body('Нуга де Монтелимар: белая нуга Прованса ', 'recipe-nougat-montelimar'),
    category: 'recipes',
    author: 'Meilleur du Chef, Chef Simon, Wikipedia, INAO',
    readTime: 6,
    image: '/images/articles/recipe-nougat-montelimar.webp',
    tags: ['нуга', 'nougat de Montelimar', 'белая нуга', 'лавандовый мёд', 'миндаль', 'прованские сладости'],
    date: '2026-06-27',
    sourceUrl: 'https://www.meilleurduchef.com/en/recipe/nougat.html',
    sourceLabel: 'Meilleur du Chef',
    recipeData: {
      prepTime: 'PT45M', cookTime: 'PT25M', yield: 'около 1,2 кг нуги',
      ingredients: ['Лавандовый мёд — 250 г', 'Сахар — 250 г', 'Сироп глюкозы — 100 г', 'Вода — 65 г', 'Яичные белки — 55 г', 'Обжаренный миндаль — 300 г', 'Зелёные фисташки — 50 г', 'Вафельная бумага (feuille azyme) — 2 листа', 'Стручок ванили — 1 шт']
    },
    faq: [
      { question: 'Сколько миндаля должно быть в нуге де Монтелимар?', answer: 'По регламенту — не менее 30% миндаля (или 28% миндаля и 2% фисташек) и не менее 25% мёда среди сахаров, из которых минимум 7% лавандового мёда из Франции.' },
      { question: 'До какой температуры варить сироп для нуги?', answer: 'Для мягкой нуги (nougat tendre) сироп доводят примерно до 145°C, мёд — до 125-130°C. При 150°C и выше нуга становится твёрдой и хрустящей.' },
      { question: 'Почему нуга липнет и не застывает?', answer: 'Чаще всего недоварен сироп (нужен petit casse около 145°C), плохо взбиты белки или высокая влажность. Помогает досушивание массы и хранение при 15-18°C, но не в холодильнике.' }
    ]
  },

  {
    ...
    sourceLabel: 'Mercotte',
    recipeData: {
      prepTime: 'PT1H', cookTime: 'PT10M', yield: 'около 30 калиссонов',
      ingredients: ['миндальная мука 250 г', 'сахарная пудра 180 г', 'цукаты дыни 200 г', 'цукаты апельсиновой цедры 40 г', 'цукаты лимона 20 г', 'вода флёрдоранж 40 мл', 'лист облатки (pain azyme) 2 шт', 'яичный белок 1 шт', 'сахарная пудра для глазури 180 г', 'сок лимона несколько капель']
    },
    faq: [
      { question: 'Можно ли заменить цукаты дыни в калиссонах?', answer: 'Цукаты дыни (в идеале дыни из Кавайона) — это подпись калиссона, они дают около 80 процентов фруктовой части. Часть массы иногда заменяют цукатами абрикоса, но регламент IGP предписывает именно дыню.' },
      { question: 'Зачем калиссону лист облатки снизу?', answer: 'Pain azyme (тонкий лист гостии из картофельного крахмала и воды) служит несклеивающимся основанием, держит мягкую пасту и отсылает к церковному происхождению сладости.' },
      { question: 'Сколько и как хранить калиссоны?', answer: 'В герметичной коробке при комнатной температуре, вдали от влаги, калиссоны сохраняют мягкость несколько недель. Холодильник не нужен и даже вреден: от сырости глазурь тускнеет.' }
    ]
  },

  {
    id: 'recipe-tarte-normande',
    title: 'Тарт норманд: яблочный пирог Нормандии с кальвадосом',
    excerpt: 'Тарт норманд (tarte normande) — яблочный тарт с кремовой заливкой из яиц, крем-фреша, сахара и кальвадоса. История, отличие от обычного, рецепт и техника.',
    content: body('Тарт норманд: яблочный пирог Нормандии с', 'recipe-tarte-normande'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Normandie Tourisme, Marmiton',
    readTime: 6,
    image: '/images/articles/recipe-tarte-normande.webp',
    tags: ['тарт норманд', 'яблочный пирог', 'нормандская кухня', 'кальвадос', 'крем-фреш', 'migaine'],
    date: '2026-07-04',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/tarte-normande--3',
    sourceLabel: 'Chef Simon',
    recipeData: {
    ...
    faq: [
      ...
      { question: 'Обязателен ли кальвадос в тарт норманд?', answer: 'Кальвадос AOC — это ароматная подпись Нормандии, но традиционно он факультативен. Его кладут около двух столовых ложек; при желании заменяют ванилью или ложкой яблочного сидра.' },
      { question: 'Какие яблоки лучше для тарт норманд?', answer: 'Reine des Reinettes, Boskoop и Reinette grise. Они ароматные, держат форму при выпечке и не дают лишней воды, поэтому заливка не становится слишком жидкой.' }
    ]
  },

  {
    id: 'recipe-blanc-manger',
    title: 'Бланманже: французский миндальный десерт на желатине',
    excerpt: 'Бланманже (blanc-manger) — холодный десерт из миндального молока, сливок и желатина: история со Средневековья, рецептура, техника, démoulage и coulis.',
    content: body('Бланманже: французский миндальный десерт', 'recipe-blanc-manger'),
    category: 'recipes',
    author: 'Wikipédia, Chef Simon, Meilleur du Chef, Larousse',
    readTime: 7,
    image: '/images/articles/recipe-blanc-manger.webp',
    tags: ['бланманже', 'blanc-manger', 'миндальное молоко', 'желатин', 'холодный десерт', 'coulis fruits rouges'],
    date: '2026-07-06',
    sourceUrl: 'https://fr.wikipedia.org/wiki/Blanc-manger',
    sourceLabel: 'Wikipédia',
    recipeData: {
      prepTime: 'PT30M', cookTime: 'PT10M', yield: '6 порций',
      ingredients: ['Миндаль очищенный 300 г', 'Молоко цельное 400 мл', 'Сливки 30% 200 мл', 'Сахар 100 г', 'Желатин листовой 6 г', 'Ваниль 1 стручок', 'Экстракт горького миндаля несколько капель', 'Ягоды красные 250 г', 'Сахарная пудра 30 г']
    },
    faq: [
      { question: 'Чем желатин отличается от агар-агара в бланманже?', answer: 'Желатин распускают в тёплой жидкости без кипения, он даёт нежное дрожащее желе. Агар-агар обязательно кипятят около минуты, и он застывает плотнее; по данным Vahine, берут примерно 2 г на 0,5 л массы.' },
      { question: 'Почему бланманже не застыл?', answer: 'Желатин не растворился до конца или его слишком мало, либо агар не довели до кипения. На 600-700 мл жидкости берут около 6 г листового желатина и охлаждают 4-5 часов.' },
      { question: 'С чем подают бланманже?', answer: 'Классически с coulis из красных ягод (малина, клубника). Ягоды прогревают недолго при температуре около 100°C, чтобы сохранить яркий алый цвет и блеск.' }
    ]
  },

  {
    id: 'recipe-marrons-glaces',
    title: 'Марон глясе: засахаренные каштаны, рецепт и история',
    excerpt: 'Марон глясе (marrons glacés) — каштаны, засахаренные в сиропе за несколько дней. История из Пьемонта и Ардеша, техника confisage, глазурь и ошибки.',
    content: body('Марон глясе: засахаренные каштаны, рецеп', 'recipe-marrons-glaces'),
    category: 'recipes',
    author: 'Wikipédia, Chef Simon, Académie du Goût, Clément Faugier',
    readTime: 6,
    image: '/images/articles/recipe-marrons-glaces.webp',
    tags: ['марон глясе', 'marrons glacés', 'засахаренные каштаны', 'confisage', 'Клеман Фожье', 'crème de marrons'],
    date: '2026-07-09',
    sourceUrl: 'https://fr.wikipedia.org/wiki/Marron_glac%C3%A9',
    sourceLabel: 'Wikipédia',
    recipeData: {
      prepTime: 'PT2H', cookTime: 'PT96H', yield: 'около 40 каштанов (1 кг)',
      ingredients: ['Каштаны marrons очищенные 1 кг', 'Сахар 1,5 кг', 'Вода 1,5 л', 'Глюкоза сироп 150 г', 'Ваниль 2 стручка', 'Сахарная пудра 100 г', 'Стерильный тюль для обёртки']
    },
    faq: [
      { question: 'В чём разница между châtaigne и marron?', answer: 'Для марон глясе берут marron — улучшенный сорт каштана без внутренней перегородки (cloison): орех цельный, не разделён плёнкой на дольки. Обычная châtaigne разгорожена и чаще крошится, хуже держит форму.' },
      { question: 'Сколько дней готовят марон глясе?', answer: 'Засахаривание (confisage) длится обычно 4-7 дней: каждый день сироп доводят до кипения и заливают им каштаны, постепенно повышая плотность с 20-25° до 32-35° по шкале Боме. Для очень крупных плодов процесс растягивается до трёх недель.' },
      { question: 'Почему каштаны разваливаются?', answer: 'Их переварили в начале, мешали ложкой или варили в сиропе на сильном огне. Берите крупные целые marrons, недоваривайте до плотности, оборачивайте по два в тюль и держите сироп на самом слабом кипении.' }
    ]
  },

  {
    id: 'recipe-tarte-au-chocolat',
    title: 'Тарт о шокола: французский шоколадный тарт на ганаше',
    excerpt: 'Настоящий tarte au chocolat: хрустящая pâte sucrée, выпеченная вслепую, и шелковистая ганаш. Пропорции, температуры, техника и разбор ошибок.',
    content: body('Тарт о шокола: французский шоколадный та', 'recipe-tarte-au-chocolat'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Académie du Goût, Valrhona',
    readTime: 6,
    image: '/images/articles/recipe-tarte-au-chocolat.webp',
    tags: ['тарт о шокола', 'tarte au chocolat', 'ганаш', 'pâte sucrée', 'шоколадный тарт', 'французская выпечка'],
    date: '2026-06-04',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/tarte-au-chocolat--13',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT40M', cookTime: 'PT25M', yield: '1 тарт 22 см / 8 порций',
      ingredients: ['Мука 250 г', 'Сливочное масло 150 г', 'Сахарная пудра 90 г', 'Миндальная мука 30 г', 'Яйцо 1 шт', 'Тёмный шоколад 60-70% 200 г', 'Сливки 33-35% 250 г', 'Сливочное масло для ганаша 40 г', 'Соль щепотка', 'Ваниль']
    },
    faq: [
      { question: 'Чем тарт о шокола отличается от шоколадного гато?', answer: 'Тарт о шокола — это выпеченная вслепую песочная основа pâte sucrée, залитая невыпекаемой ганашью из шоколада и сливок. Гато — это цельное бисквитное или флан-тесто, выпекаемое вместе с шоколадом.' },
      { question: 'Какой шоколад брать для ганаша?', answer: 'Тёмный кувертюр 60-70% какао. Более крепкий (например, 80%) даёт жёсткую, ломкую ганашь; молочный и белый требуют иных пропорций из-за большей доли жира.' },
      { question: 'Нужно ли запекать ганашь в духовке?', answer: 'Классически нет: ганашь заливают в холодный испечённый корж и дают ей стабилизироваться при комнатной температуре или в холоде. Некоторые чефы подсушивают её в остывающей духовке 10-15 минут для более плотной текстуры.' }
    ]
  },

  {
    id: 'recipe-creme-caramel',
    title: 'Крем-карамель: французская crème renversée с карамелью',
    excerpt: 'Настоящая crème caramel: карамель на дне формы, нежный заварной крем на яйцах, выпечка на водяной бане и переворот. Пропорции, температуры, ошибки.',
    content: body('Крем-карамель: французская crème renvers', 'recipe-creme-caramel'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Marmiton, Wikipédia',
    readTime: 6,
    image: '/images/articles/recipe-creme-caramel.webp',
    tags: ['крем карамель', 'crème caramel', 'crème renversée', 'заварной крем', 'карамель', 'французский десерт'],
    date: '2026-06-09',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/creme-renversee-au-caramel--5',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT30M', cookTime: 'PT1H', yield: '6 порций',
      ingredients: ['Молоко цельное 500 мл', 'Сливки 33% 250 мл', 'Сахар для крема 150 г', 'Сахар для карамели 250 г', 'Яйца целые 6 шт', 'Желтки 4 шт', 'Ваниль 2 стручка', 'Вода для карамели 2 ст. л.']
    },
    faq: [
      { question: 'Чем крем-карамель отличается от крем-брюле?', answer: 'Крем-карамель — это заварной крем, выпеченный на водяной бане и перевёрнутый на жидкую карамель, которая стекает соусом. Крем-брюле не переворачивают, а карамельную корочку пламенем горелки создают сверху перед подачей.' },
      { question: 'Почему карамель горчит?', answer: 'Сахар переварили. Нужный цвет — янтарный, близкий к коньяку, с ореховым ароматом. Тёмно-коричневая карамель уже горькая и не спасается.' },
      { question: 'Почему в креме появились пузырьки и дырочки?', answer: 'Вода в водяной бане закипела или массу слишком взбили. Держите баню ниже кипения, размешивайте мягко и процеживайте смесь перед выпечкой.' }
    ]
  },

  {
    id: 'recipe-mousse-au-chocolat',
    title: 'Мусс о шокола: классический французский шоколадный мусс',
    excerpt: 'Мусс о шокола (mousse au chocolat) - две школы, точная техника взбитых белков, температуры шоколада и разбор ошибок от французских шефов.',
    content: body('Мусс о шокола: классический французский ', 'recipe-mousse-au-chocolat'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Valrhona, Hervé This',
    readTime: 6,
    image: '/images/articles/recipe-mousse-au-chocolat.webp',
    tags: ['мусс о шокола', 'mousse au chocolat', 'шоколадный мусс', 'французские десерты', 'взбитые белки', 'Эрве Тис'],
    date: '2026-06-11',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/mousse-chocolat-noir',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT30M', cookTime: 'PT0M', yield: '6 порций',
      ingredients: ['Тёмный шоколад 70% - 200 г', 'Яйца - 6 шт', 'Сахар - 30 г', 'Щепотка соли', 'Сливочное масло - 30 г (по желанию)', 'Ванильный экстракт - по вкусу']
    },
    faq: [
      { question: 'Почему мусс о шокола получается зернистым?', answer: 'Чаще всего шоколад был слишком горячим и свернул желтки, либо белки перевзбили. Соединяйте шоколад при 40-45°C и складывайте массу нежно лопаткой.' },
      { question: 'Обязательны ли сырые яйца в муссе о шокола?', answer: 'Нет. Классическая школа строится на желтках и взбитых белках, но существует школа на ганаше с взбитыми сливками, без сырых яиц.' },
      { question: 'Сколько мусс должен стоять в холоде?', answer: 'Минимум 2 часа, лучше 4 часа или ночь. За это время какао-масло кристаллизуется и мусс обретает плотную кремовую текстуру.' }
    ]
  },

  {
    id: 'recipe-fondant-chocolat',
    title: 'Фондан о шокола: секрет жидкого шоколадного сердца',
    excerpt: 'Фондан о шокола (fondant au chocolat) - разница между фондан, муалё и кулан, история кулана Мишеля Браса и точная техника жидкого сердца.',
    content: body('Фондан о шокола: секрет жидкого шоколадн', 'recipe-fondant-chocolat'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Academie du Gout, Michel Bras',
    readTime: 6,
    image: '/images/articles/recipe-fondant-chocolat.webp',
    tags: ['фондан о шокола', 'fondant au chocolat', 'кулан', 'moelleux', 'Мишель Брас', 'шоколадный десерт'],
    date: '2026-06-14',
    sourceUrl: 'https://chefsimon.com/gourmets/sarah/recettes/le-meilleur-fondant-au-chocolat-du-monde-2a4180c6-c3ac-465a-8910-a07dd728d99e',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT20M', cookTime: 'PT10M', yield: '6 порций',
      ingredients: ['Тёмный шоколад 70% - 200 г', 'Сливочное масло - 150 г', 'Яйца - 4 шт', 'Сахар - 100 г', 'Мука - 50 г', 'Щепотка соли']
    },
    faq: [
      { question: 'В чём разница между фондан и муалё о шокола?', answer: 'Фондан плотнее и влажнее внутри с почти сырой серединой, муалё пропечён насквозь и воздушнее, ближе к кексу. Всё решает время выпечки.' },
      { question: 'Как получить жидкое сердце в фондане?', answer: 'Короткая выпечка при высокой температуре: 180-200°C около 8-10 минут. Края схватились, центр дрожит - значит, сердце ещё жидкое.' },
      { question: 'Почему фондан прилипает к форме?', answer: 'Форму нужно щедро смазать маслом и присыпать мукой или какао. После выпечки дайте фондану постоять 10-15 минут, прежде чем вынимать.' }
    ]
  },

  {
    id: 'recipe-pain-perdu',
    title: 'Пан пердю (pain perdu): французские гренки из чёрствого хлеба',
    excerpt: 'Пан пердю — классический французский десерт из чёрствого хлеба: история, пропорции молочно-яичного аппарата, тремпаж и жарка на масле, разбор ошибок.',
    content: body('Пан пердю (pain perdu): французские грен', 'recipe-pain-perdu'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Academie du Gout, fr.wikipedia',
    readTime: 6,
    image: '/images/articles/recipe-pain-perdu.webp',
    tags: ['пан пердю', 'французские гренки', 'pain perdu', 'чёрствый хлеб', 'бриошь', 'антигаспи'],
    date: '2026-06-19',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/pain-perdu--10',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT15M', cookTime: 'PT10M', yield: '4 порции (6-8 ломтиков)',
      ingredients: ['чёрствая бриошь или багет — 6-8 ломтиков', 'молоко цельное — 500 мл', 'яйца — 3-4 шт', 'сахар — 60-75 г', 'сахар ванильный — 1 пакетик', 'сливочное масло — 40 г', 'сахарная пудра для подачи', 'щепотка соли']
    },
    faq: [
      { question: 'Почему десерт называется pain perdu, то есть «потерянный хлеб»?', answer: 'Потому что чёрствый хлеб, который иначе выбросили бы, «спасают» от потери: его размачивают и обжаривают. Это старинное антигаспи-блюдо бедной кухни.' },
      { question: 'Какой хлеб брать для пан пердю?', answer: 'Чёрствый хлеб 2-3-дневной давности: багет, пан-де-ми или, для роскошной версии, бриошь. Свежий хлеб размокает и разваливается.' },
      { question: 'Как долго вымачивать ломтики в аппарате?', answer: 'Плотный багет — до 10 секунд с каждой стороны, мягкий пан-де-ми — 3-5 секунд. Хлеб должен пропитаться, но не расползаться в руках.' }
    ]
  },

  {
    id: 'recipe-chou-chantilly',
    title: 'Шу шантийи (chou chantilly): заварные с кремом по-французски',
    excerpt: 'Шу шантийи — заварные пирожные из pate a choux с кремом шантийи: заварное тесто, дессешман, кракелен, крем дипломат, сборка и разбор главных ошибок.',
    content: body('Шу шантийи (chou chantilly): заварные с ', 'recipe-chou-chantilly'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Mercotte, fr.wikipedia',
    readTime: 6,
    image: '/images/articles/recipe-chou-chantilly.webp',
    tags: ['шу шантийи', 'заварное тесто', 'pate a choux', 'крем шантийи', 'кракелен', 'крем дипломат'],
    date: '2026-06-24',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/pate-a-choux-et-eclairs',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT40M', cookTime: 'PT30M', yield: 'около 20 заварных',
      ingredients: ['вода — 125 мл', 'молоко цельное — 125 мл', 'сливочное масло — 100 г', 'мука Т45/Т55 — 150 г', 'яйца — 250 г (около 5 шт)', 'соль — 3 г', 'сливки 30-35% — 500 мл', 'сахарная пудра — 50 г', 'ваниль — 1 стручок']
    },
    faq: [
      { question: 'Почему заварные (choux) опадают после выпечки?', answer: 'Чаще всего тесто недостаточно высушено (дессешман) или духовку открыли слишком рано. Недосушенная панада даёт плоские опадающие choux.' },
      { question: 'Сколько яиц добавлять в заварное тесто?', answer: 'Не по счёту, а по консистенции. Меркотт советует брать вес яиц, равный весу жидкости. Тесто готово, когда борозда от лопатки медленно затягивается.' },
      { question: 'Зачем нужен кракелен на заварных?', answer: 'Диск из масла, муки и сахара при выпечке обволакивает chou, не даёт ему трескаться и обеспечивает ровную круглую форму и хрустящую сладкую корочку.' }
    ]
  },

  {
    ...
    readTime: 6,
    image: '/images/articles/recipe-savarin.webp',
    tags: ['саварен', 'savarin', 'французская выпечка', 'дрожжевое тесто', 'сироп имбибаж', 'ромовый торт'],
    date: '2026-06-29',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/savarin-et-baba',
    sourceLabel: 'Chef Simon',
    recipeData: {
      prepTime: 'PT45M', cookTime: 'PT20M', yield: '1 саварен-корона на 8 порций',
      ingredients: ['мука 250 г', 'свежие дрожжи 10 г', 'яйца 4 шт', 'сливочное масло 100 г', 'сахар 15 г', 'соль 5 г', 'вода для сиропа 500 мл', 'сахар для сиропа 200 г', 'ром 80 мл', 'сливки 33% 200 мл', 'свежие фрукты для центра']
    },
    faq: [
      { question: 'Чем саварен отличается от бабы ромовой?', answer: 'Саварен выпекают в кольцевой форме-короне и делают из того же дрожжевого теста, но без изюма; бабу пекут в форме-бочонке, а в тесто добавляют изюм. Полое кольцо саварена наполняют кремом или фруктами.' },
      { question: 'При какой температуре пропитывать саварен сиропом?', answer: 'Изделие должно быть тёплым (около 40 градусов), а сироп горячим, но не кипящим. Ром добавляют, когда сироп остыл до 60-70 градусов, чтобы сохранить аромат. Пропитывают в несколько приёмов.' },
      { question: 'Почему саварен получается сухим или, наоборот, разваливается?', answer: 'Сухой саварен - результат слишком холодного или недостаточного сиропа. Раскисший, разваливающийся - от слишком горячего сиропа, вылитого разом. Нужен тёплый мякиш, тёплый сироп и пропитка порциями.' }
    ]
  },

  {
    id: 'recipe-tarte-au-sucre',
    title: 'Тарт о сюкр: сахарный тарт Севера Франции',
    excerpt: 'Тарт о сюкр (tarte au sucre) — бриошная основа с вержуазой, кремом и маслом. История сахарного тарта Севера, рецептура, техника и разбор ошибок.',
    content: body('Тарт о сюкр: сахарный тарт Севера Франци', 'recipe-tarte-au-sucre'),
    category: 'recipes',
    author: 'Chef Simon, Academie du Gout, 750g, Wikipedia FR',
    readTime: 7,
    ...
    faq: [
      { question: 'Чем отличается вержуаза от кассонада?', answer: 'Вержуаза (vergeoise) — свекловичный сахар из остаточного сиропа, мягкий, влажный, с карамельным вкусом. Классический кассонад — тростниковый, сухой, с ванильными нотами. На Севере Франции и в Бельгии вержуазу часто называют кассонадом.' },
      { question: 'Почему тарт о сюкр делают на дрожжевом тесте, а не на песочном?', answer: 'Настоящий тарт Севера — это pâte levée, бриошная дрожжевая основа. Мягкий пышный мякиш даёт контраст с карамелизованным сахаром сверху. Песочная основа с заливкой — это уже квебекская версия tarte au sucre.' },
      { question: 'При какой температуре выпекать тарт о сюкр?', answer: 'Около 170-180 °C примерно 20-25 минут. Ориентир — золотистая корочка и запах карамели. Пересушивать нельзя: при слишком долгой выпечке мякиш становится сухим, а сахар горчит.' }
    ]
  },

  {
    id: 'recipe-beignets',
    title: 'Бенье: французские пончики Марди Гра',
    excerpt: 'Бенье (beignets) — французские дрожжевые пончики во фритюре. Пышное тесто, температура масла 170-180 °C, сахарная пудра. Рецепт, история Марди Гра и ошибки.',
    content: body('Бенье: французские пончики Марди Гра', 'recipe-beignets'),
    category: 'recipes',
    author: 'Chef Simon, Academie du Gout, Atelier des Chefs, Wikipedia FR',
    readTime: 6,
    ...
    faq: [
      { question: 'Какой должна быть температура масла для бенье?', answer: 'Оптимально 170-180 °C. Слишком холодное масло тесто впитывает, и пончики выходят жирными; слишком горячее — они подгорают снаружи и остаются сырыми внутри. Без термометра проверяют кусочком теста: он должен всплывать медленно и румяниться постепенно.' },
      { question: 'Чем бенье отличаются от бунь (bugnes) и мервей?', answer: 'Бенье на дрожжевом тесте — пышные и объёмные. Бунь лионские тоньше и в форме узелка, мервей с юго-запада плотнее и часто с флёрдоранж, орейетт из Прованса тонкие и хрустящие. Все это семья карнавальных пончиков Марди Гра.' },
      { question: 'Почему бенье получаются жирными?', answer: 'Главная причина — недостаточная температура масла: тесто впитывает жир вместо того, чтобы быстро схватиться. Также виновато слишком жидкое или недорасстоявшееся тесто. После жарки выкладывайте пончики на решётку, а не сразу на бумагу.' }
    ]
  },

  {
    id: 'recipe-gaufres',
    title: 'Гофры: бельгийские вафли Брюссель и Льеж дома',
    excerpt: 'Настоящие бельгийские гофры (gaufres): лёгкая брюссельская на дрожжах и взбитых белках и плотная льежская на жемчужном сахаре. Рецепты, тесто, вафельница, ошибки.',
    content: body('Гофры: бельгийские вафли Брюссель и Льеж', 'recipe-gaufres'),
    category: 'recipes',
    author: 'Chef Simon, Meilleur du Chef, Academie du Gout, Marmiton',
    readTime: 6,
    image: '/images/articles/recipe-gaufres.webp',
    tags: ['гофры', 'вафли бельгийские', 'gaufres', 'гофра брюссельская', 'гофра льежская', 'жемчужный сахар'],
    date: '2026-07-08',
    sourceUrl: 'https://chefsimon.com/gourmets/chef-simon/recettes/gaufres--5',
    sourceLabel: 'Chef Simon — Gaufres',
    recipeData: {
      prepTime: 'PT30M', cookTime: 'PT4M', yield: 'около 10 гофр',
      ingredients: ['мука 500 г', 'молоко 500 мл', 'газированная вода 200 мл', 'свежие дрожжи 20 г', 'яйца 4 шт', 'сливочное масло 200 г', 'сахар 15 г', 'соль щепотка', 'жемчужный сахар 200 г для льежских', 'сахарная пудра для подачи']
    },
    faq: [
      { question: 'Чем гофра брюссельская отличается от льежской?', answer: 'Брюссельская - лёгкая и хрустящая, из жидкого дрожжевого теста со взбитыми белками, прямоугольная, несладкая, служит основой под фрукты и шантийи. Льежская - плотная, из бриошного теста с жемчужным сахаром, овальная и сладкая сама по себе.' },
      { question: 'Что такое жемчужный сахар и чем его заменить?', answer: 'Жемчужный сахар (sucre perlé) - крупные термостойкие крупинки, которые карамелизуются и дают хруст в льежской гофре. Исторически использовали леденцовый сахар (candi). Его добавляют в самом конце, чтобы он не растворился.' },
      { question: 'Почему гофры получаются мягкими и не хрустят?', answer: 'Причина - недостаточно горячая вафельница, слишком короткая выпечка или пар. Прогрейте прибор до 180-200 градусов, не открывайте раньше 3-4 минут и остужайте гофры на решётке, не складывая стопкой.' }
    ]
  },
