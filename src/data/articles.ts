...
export const articles: Article[] = [
  ...
  { id: 'perret-softness-volume', title: 'Перре: объем, мягкость, воздушность и хрупкость как язык десерта', excerpt: 'Разбор интервью Madame Figaro: почему нож должен входить без сопротивления, а вкус нельзя приносить в жертву эстетике.', content: body('Франсуа Перре', 'perret-softness-volume'), category: 'francois-perret', author: 'Madame Figaro, WWD', readTime: 2, image: '/images/articles/perret-softness-volume.webp', tags: ['мягкость', 'Ritz', 'сахар', 'текстура'], sourceUrl: 'https://www.ritzparislecomptoir.com/en/francois-perret', date: '2025-02-01', sourceLabel: 'Ritz Paris Le Comptoir' },
  ...
  { id: 'conticini-praline', title: 'Пралине Контисини: осмос ореха, сахара и воды', excerpt: 'Почему один и тот же рецепт пралине может давать разный вкус: 0,5% воды в кожице фундука.', content: body('Филипп Контисини', 'conticini-praline'), category: 'philippe-conticini', author: 'So Good Magazine', readTime: 7, image: '/images/articles/conticini-praline.webp', tags: ['пралине', 'осмос', 'фундук'], sourceUrl: 'https://www.sogoodmagazine.com/pastry-blog/pastry-chef-articles/philippe-conticini-interview/', date: '2025-04-10', sourceLabel: 'So Good Magazine' },
  { id: 'crookie-conticini', title: 'Crookie: от парижской булочной до мирового тренда', excerpt: 'Как Стефан Лувар из Maison Louvard создал гибрид круассана и cookie, а TikTok сделал его вирусным.', content: body('Crookie Maison Louvard', 'crookie-conticini'), category: 'french-cuisine', author: 'Grokipedia, Maison Louvard', readTime: 6, image: '/images/articles/crookie-conticini.webp', tags: ['Crookie', 'Лувар', 'тренды', '2024'], sourceUrl: 'https://grokipedia.com/page/Crookie', date: '2025-04-20', sourceLabel: 'Grokipedia' },
