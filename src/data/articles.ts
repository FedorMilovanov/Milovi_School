...
export const articles: Article[] = [
  ...
  { id: 'perret-softness-volume', title: 'Перре: объем, мягкость, воздушность и хрупкость как язык десерта', excerpt: 'Проверенный разбор стиля François Perret: мягкость, объём, лёгкость и десерты Ritz Paris без неподтверждённых цитат.', content: body('Франсуа Перре', 'perret-softness-volume'), category: 'francois-perret', author: 'Ritz Paris, So Good Magazine, Books for Chefs', readTime: 3, image: '/images/articles/perret-softness-volume.webp', tags: ['мягкость', 'Ritz', 'сахар', 'текстура'], sourceUrl: 'https://www.ritzparislecomptoir.com/en/francois-perret', date: '2025-02-01', sourceLabel: 'Ritz Paris Le Comptoir' },
  ...
  { id: 'conticini-praline', title: 'Пралине Контисини: орехи, сироп 116–118°C и карамелизация', excerpt: 'Проверенная формула Philippe Conticini: 300 г фундука, 300 г миндаля, 400 г сахара, 100 г воды и стадия sablage.', content: body('Филипп Контисини', 'conticini-praline'), category: 'philippe-conticini', author: 'Philippe Conticini, Meilleur du Chef', readTime: 3, image: '/images/articles/conticini-praline.webp', tags: ['пралине', 'осмос', 'фундук'], sourceUrl: 'https://www.meilleurduchef.com/fr/recette/praline-maison.html', date: '2025-04-10', sourceLabel: 'Meilleur du Chef' },
  { id: 'crookie-conticini', title: 'Crookie: от парижской булочной до мирового тренда', excerpt: 'Как Стефан Лувар из Maison Louvard создал гибрид круассана и cookie, а TikTok сделал его вирусным.', content: body('Crookie Maison Louvard', 'crookie-conticini'), category: 'french-cuisine', author: 'BBC Travel, AFP, Maison Louvard', readTime: 3, image: '/images/articles/crookie-conticini.webp', tags: ['Crookie', 'Лувар', 'тренды', '2024'], sourceUrl: 'https://www.bbc.com/travel/article/20240305-the-surprisingly-complicated-history-of-the-croissant', date: '2025-04-20', sourceLabel: 'BBC Travel' },
  ...
  { id: 'tech-choux', title: 'Заварное тесто: научная логика и диагностика ошибок', excerpt: 'Крахмал, пар, полость, яйца, подсушка, трещины и гладкая поверхность для эклеров и шу.', content: body('Заварное тесто', 'tech-choux'), category: 'techniques', author: 'Food52, CAP pastry notes', readTime: 5, image: '/images/articles/tech-choux.webp', tags: ['заварное тесто', 'пар', 'panade', 'углублено'], sourceUrl: 'https://food52.com/story/14068-how-to-make-crullers-master-pate-a-choux-along-the-way', date: '2025-06-20', sourceLabel: 'Food52',
    faq: [
      { question: 'Почему эклеры рвутся по бокам во время выпечки?', answer: 'Чаще всего из-за слишком горячей духовки в начале выпечки (выше 200°C) или из-за недостатка влаги в тесте. Яйца добавляют в последнюю очередь — их количество определяет текстуру, а не рецепт «по граммам».' },
      { question: 'Сколько яиц нужно в заварном тесте?', answer: 'Зависит от влажности муки, размера яиц и времени сушки panade. Точное количество определяют по текстуре: тесто должно медленно стекать с лопатки «лентой» V-образной формы, а не каплями или комком.' },
      { question: 'Зачем подсушивать тесто в духовке перед основной выпечкой?', answer: 'Подсушка (5–10 минут при 170°C без пара) позволяет крахмалу зафиксировать форму и создать полость для пара. Без неё эклеры опадут или не дадут полости.' },
      { question: 'Можно ли хранить заварное тесто в холодильнике?', answer: 'Да, до 24 часов в герметичном контейнере. После холода тесто нужно заново перемешать, чтобы восстановить однородность. Не замораживайте — структура нарушится.' }
    ]
  },
  ...
  { id: 'tech-mirror-glaze', title: 'Глазурь miroir без пузырей: температура, блендер и замороженный entremets', excerpt: 'Полная диагностика зеркальной глазури: глюкоза, желатин, шоколад, температура 28-32°C.', content: body('Зеркальная глазурь', 'tech-mirror-glaze'), category: 'techniques', author: 'CAP pastry notes', readTime: 3, image: '/images/articles/tech-mirror-glaze.webp', tags: ['глазурь', 'miroir', 'entremets'], sourceUrl: 'https://ecoledepatisserie-boutique.com/fr-us/blogs/patisserie-conseil-professionnel/preparation-cap-patisserie', date: '2025-08-10', sourceLabel: 'CAP pastry notes',
    faq: [
      { question: 'Глазурь ложится с пузырями. Как убрать?', answer: 'Пробить погружным блендером 1–2 минуты, не поднимая его из жидкости (чтобы не загнать воздух). Затем дать отдохнуть 4–6 часов в холодильнике — пузыри поднимутся на поверхность и исчезнут.' },
      { question: 'Какая правильная температура глазури?', answer: '30–32°C для классической зеркальной глазури. Ниже — глазурь слишком густая и плохо растекается. Выше — слишком жидкая, не держится на entremets.' },
      { question: 'Какой entremets нужно использовать?', answer: 'Замороженный минимум до -18°C. Тёплый entremets расплавит глазурь. Достать из морозилки за 5 минут до глазирования — поверхность должна быть покрыта тонким слоем инея.' },
      { question: 'Можно ли использовать нейтральную глазурь?', answer: 'Да, для фруктовых entremets нейтральная глазурь (без шоколада) лучше — она прозрачная и не перебивает цвет глазури. Зеркальная (с шоколадом) даёт более плотный слой и насыщенный цвет.' }
    ]
  },
  ...
  { id: 'tech-feuilletage', title: 'Feuilletage без провалов: почему слоёное тесто не поднимается', excerpt: 'Полная диагностика: детремп, масло для раскатки, простые и двойные туры, выпечка.', content: body('Слоёное тесто', 'tech-feuilletage'), category: 'techniques', author: 'Atouts Gourmands, CAP pastry notes', readTime: 5, image: '/images/articles/tech-feuilletage.webp', tags: ['слоёное тесто', 'масло', 'выпечка'], sourceUrl: 'https://atoutsgourmands.wordpress.com/2023/01/12/pate-feuilletee-comprendre-et-maitriser/', date: '2025-09-20', sourceLabel: 'Atouts Gourmands',
    faq: [
      { question: 'Почему тесто получилось плотным, без слоёв?', answer: 'Скорее всего масло растопилось в тесто во время раскатки. Это значит: масло было слишком тёплым или кухня жаркая. Решение: всё охладить, начать заново. Для домашних условий лучше работать при 18–20°C.' },
      { question: 'Какое масло использовать — сливочное или специальное tourage?', answer: 'Для домашнего круассана подходит сливочное масло 82–84% жирности (tourage butter). Маргарин даёт слои, но не вкус. Идеальный вариант — beurre sec (сухое масло) с 84% жира, которое не тает быстро.' },
      { question: 'Сколько туров делать?', answer: 'Классический рецепт: 2 двойных тура + 1 простой. Можно 3 простых тура, но тогда слоёв будет меньше. Двойной тур = 4 видимых слоя, простой = 2.' },
      { question: 'Сколько раз можно раскатывать тесто?', answer: 'Оптимально 3 тура. Каждая раскатка теряет 1–2% масла в тесте (вместо «слои»). Больше туров — сухое тесто без чётких слоёв.' }
    ]
  },
  { id: 'tech-creme-pat', title: 'Заварной крем без комков: гладкий и доваренный', excerpt: 'Профессиональная схема: темперирование желтков, крахмал, кипячение, охлаждение и стабилизация.', content: body('Заварной крем', 'tech-creme-pat'), category: 'techniques', author: 'CAP pastry notes', readTime: 4, image: '/images/articles/tech-creme-pat.webp', tags: ['заварной крем', 'крахмал', 'ваниль'], sourceUrl: 'https://ecoledepatisserie-boutique.com/fr-us/blogs/patisserie-conseil-professionnel/preparation-cap-patisserie', date: '2025-10-01', sourceLabel: 'CAP pastry notes',
    faq: [
      { question: 'Зачем кипятить заварной крем 1–2 минуты?', answer: 'Чтобы убрать вкус сырого крахмала. Если крем не прокипятить, он будет иметь «клейстерный» привкус. Это профессиональное правило CAP Pâtissier: «прокипятить до полного раскрытия крахмала».' },
      { question: 'Можно ли заменить кукурузный крахмал на муку?', answer: 'Да, но мука даёт более «хлебный» вкус и менее прозрачную текстуру. Кукурузный крахмал — стандарт для crème pâtissière. Соотношение: 1 ст.л. муки ≈ 1 ч.л. кукурузного крахмала.' },
      { question: 'Крем получился жидким. Что делать?', answer: 'Не доварили. Верните на медленный огонь и варите ещё 2–3 минуты, постоянно помешивая. Также проверьте пропорцию желтков — минимум 4 шт на 500 мл молока для классического крема.' },
      { question: 'Как хранить заварной крем?', answer: 'В холодильнике до 48 часов, накрыв плёнкой «в контакт» (плёнка касается поверхности крема — это предотвращает корку). Не замораживайте — текстура нарушится.' }
    ]
  },
  ...
  { id: 'tech-madeleine', title: 'Madeleine: бугорок не магия, а температурный шок', excerpt: 'Почему появляется bosse: холодное тесто, горячая форма, двухэтапная выпечка и металлическая форма.', content: body('Мадлен бугорок', 'tech-madeleine'), category: 'techniques', author: 'BakingLikeAChef, Pardon Your French', readTime: 4, image: '/images/articles/tech-madeleine.webp', tags: ['мадлен', 'bosse', 'температура'], sourceUrl: 'https://www.bakinglikeachef.com/secrets-of-the-madeleine-hump/', date: '2024-09-15', sourceLabel: 'BakingLikeAChef',
    faq: [
      { question: 'Почему горб не появляется?', answer: 'Три условия должны быть выполнены одновременно: тесто реально холодное (минимум 1 час, лучше ночь в холодильнике), духовка достаточно горячая (210–220°C), форма холодная. Любое нарушение — плоская мадлен без горба.' },
      { question: 'Можно ли использовать силиконовую форму?', answer: 'Не рекомендуется для классического горба. Силикон проводит тепло медленнее металла, поэтому горб формируется хуже. Металлическая форма — обязательное условие для получения культового «bosse».' },
      { question: 'Зачем нужно двухэтапное выпекание?', answer: 'Первые 5 минут при 210°C создают термический шок — поверхность мгновенно схватывается, тесто внутри продолжает подъём и прорывает слабую точку, формируя горб. Затем снижение до 180°C позволяет пропечь середину без пересушивания.' },
      { question: 'Чем отличается beurre noisette от обычного масла?', answer: 'Beurre noisette — это жжёное масло: сливочное масло нагревают до янтарного цвета и орехового аромата. Оно даёт глубину вкуса, которой нет у обычного растопленного масла. Это ключевой ингредиент настоящей мадлен.' }
    ]
  },
  ...
  { id: 'recipe-pecan-chocolate-creme-brulee', title: "Entremets «Пекан, шоколад и крем-брюле»: рецепт от Ogre de Carrouselberg", excerpt: 'Полная технологическая карта мини-тарт от лилльского кондитера: пралине из пекана, ганаш-монте, шоколадный бисквит и крем-брюле как вставка.', content: body('recipe-pecan-chocolate-creme-brulee', 'recipe-pecan-chocolate-creme-brulee'), category: 'recipes', author: 'Fou de Pâtisserie, Ogre de Carrouselberg, defis-patisserie.com', readTime: 4, image: localImages.pecan, tags: ['рецепт', 'пекан', 'шоколад', 'крем-брюле', 'entremets'], sourceUrl: 'https://defis-patisserie.com/decouvrez-lentremets-noix-de-pecans-chocolat-et-creme-brulee/', date: '2024-11-01', sourceLabel: 'defis-patisserie.com',
    recipeData: {
      prepTime: 'PT1H30M', cookTime: 'PT40M', yield: '8 мини-десертов',
      ingredients: ['Пекан (сырой) — 200 г', 'Сахар для пралине — 150 г', 'Вода для карамели — 40 мл', 'Сливочное масло (для бисквита) — 80 г', 'Тёмный шоколад 70% — 120 г', 'Молочный шоколад — 80 г', 'Сливки 35% (для ганаша) — 300 мл', 'Желатин (200 bloom) — 6 г', 'Желтки (для вставки crème brûlée) — 3 шт', 'Сливки 30% (для вставки) — 200 мл', 'Сахар (для вставки) — 40 г', 'Ваниль — 1 стручок', 'Feuilletine / вафельная крошка — 50 г', 'Какао-масло (для велюра) — 100 г']
    },
    faq: [
      { question: 'Можно ли сделать десерт за один день?', answer: 'Технически — да, но качество пострадает. Ганаш-монте нуждается в созревании (минимум 4 часа в холодильнике), вставка crème brûlée требует полной заморозки, пекановое пралине стабилизируется 12 часов. Двухдневный план — рабочий стандарт.' },
      { question: 'Пекан горчит в готовом десерте. Что не так?', answer: 'Орех был пережарен или карамель слишком тёмная. Жарьте пекан при 170°C 12–15 минут, ориентируясь не только на время, но и на аромат. Карамель для пралине — строго янтарная (165–170°C), не коричневая.' },
      { question: 'Чем заменить пекан, если его нет?', answer: 'Грецкий орех (близкий профиль, чуть более терпкий) или смесь грецкого с фундуком 1:1. Бразильский орех слишком маслянистый и перебивает шоколад. Миндаль даёт другой, более нейтральный вкус.' }
    ]
  },
...

  {
    ...
    recipeData: {
      prepTime: 'PT2H30M', cookTime: 'PT40M', yield: 'Тарт ⌀22 см или 6 тарталеток ⌀9 см',
      ingredients: ['Тесто: сливочное масло 125 г', 'Тесто: сахарная пудра 90 г', 'Тесто: миндальная мука 30 г', 'Тесто: яйцо 1 шт (50 г)', 'Тесто: мука T55 210 г', 'Крем: лимонный сок 150 мл', 'Крем: цедра 2 лимонов', 'Крем: сахар 150 г', 'Крем: яйца 3 шт + 2 желтка', 'Крем: сливочное масло 100 г', 'Меренга: белки 3 шт (90 г)', 'Меренга: сахар 200 г', 'Меренга: вода 60 г']
    },
    faq: [
      { question: 'Можно ли заранее выпечь основу?', answer: 'Да, и это рекомендуется. Pâte sablée выдерживают в холодильнике минимум 1 час до выпечки и хранят после выпечки 1–2 дня в герметичном контейнере. Сразу после выпечки нанесите тонкий слой растопленного белого шоколада — это водонепроницаемый барьер.' },
      { question: 'Почему лимонный крем свернулся?', answer: 'Перегрев выше 82°C. Лимонный курд не любит кипения — держите температуру строго ниже 82°C и снимайте с огня при первых признаках загустения.' },
      { question: 'Меренга "плачет" и размачивает основу.', answer: 'Использовали французскую или швейцарскую меренгу вместо итальянской. Только итальянская (с горячим сиропом 118°C) даёт стабильную структуру, которая не отдаёт воду.' }
    ]
  },

  {
    ...
    recipeData: {
      prepTime: 'PT1H30M', cookTime: 'PT40M', yield: '8 порций (1 круг)',
      ingredients: ['Заварное тесто: вода 125 мл', 'Заварное тесто: молоко 125 мл', 'Заварное тесто: сливочное масло 110 г', 'Заварное тесто: мука T45 140 г', 'Заварное тесто: яйца 4 шт (около 200 г)', 'Заварное тесто: сахар 5 г', 'Заварное тесто: соль 5 г', 'Пралине: фундук 100 г', 'Пралине: сахар 100 г', 'Пралине: вода 30 мл', 'Крем-муслин: молоко 250 мл', 'Крем-муслин: желтки 4 шт', 'Крем-муслин: сахар 60 г', 'Крем-муслин: крахмал 25 г', 'Крем-муслин: сливочное масло 200 г', 'Декор: миндальные лепестки 50 г', 'Декор: сахарная пудра для посыпки']
    },
    faq: [
      { question: 'Почему кольцо из заварного теста осело после выпечки?', answer: 'Либо тесто было недостаточно высушено перед выпечкой (нужно подсушить 10 минут при 170°C без пара), либо яйца введены слишком интенсивно и структура нарушена. Яйца вводят постепенно, до состояния "с лентой".' },
      { question: 'Пралине в креме горчит. Что делать?', answer: 'Фундук был пережарен или карамель слишком тёмная. Жарьте фундук при 150°C 12–15 минут до светло-золотистого цвета и характерного орехового аромата. Карамель — светло-янтарная (около 165°C).' },
      { question: 'Можно ли использовать вариант Контисини (с "пряткой" пралине)?', answer: 'Да — это его классический приём: после наполнения нижней части кольца кремом-муслин в центре делается углубление, куда выкладывается цельное пралине, затем закрывается вторым слоем крема. При укусе гость находит сюрприз в сердцевине.' }
    ]
  },

  // ── MERCOTTE ────────────────────────────────────────────────────────────────
  { id: 'mercotte-tarte-citron', title: 'Меркотт: тарт с лимоном — кислота, баланс и идеальная меренга', excerpt: 'Разбор классического лимонного тарта: песочное тесто, crème citron без желатина и итальянская меренга с горелкой.', content: body('Меркотт тарт лимон', 'mercotte-tarte-citron'), category: 'mercotte', author: 'Mercotte, CAP pastry notes', readTime: 3, image: '/images/articles/mercotte-tarte-citron.webp', tags: ['тарт', 'лимон', 'меренга', 'крем'], sourceUrl: 'https://www.mercotte.fr/category/les-bases/', date: '2026-04-10', sourceLabel: 'Mercotte' },
  { id: 'mercotte-entremets-system', title: 'Меркотт: энтреме от А до Я — бисквит, мусс, гляссаж, сборка', excerpt: 'Система подготовки к CAP Pâtisserie и домашним энтреме: вкладыш, кольцо, температура зеркальной глазури.', content: body('Меркотт энтреме система', 'mercotte-entremets-system'), category: 'mercotte', author: 'Mercotte, Elle à Table, CAP', readTime: 3, image: '/images/articles/mercotte-entremets-system.webp', tags: ['энтреме', 'мусс', 'гляссаж', 'CAP'], sourceUrl: 'https://www.mercotte.fr/category/entremets/', date: '2026-04-15', sourceLabel: 'Mercotte' },

  // ── JACQUES GENIN ────────────────────────────────────────────────────────────
  { id: 'genin-caramel-philosophy', title: 'Жак Жени: философия карамели — горечь, соль, время и терруар', excerpt: 'Как человек без диплома создал лучшую карамель Парижа: почему карамель нельзя спешить и что значит «карамель au beurre salé de Guérande».', content: body('Жак Жени карамель', 'genin-caramel-philosophy'), category: 'jacques-genin', author: 'Paris by Mouth, Food & Sens', readTime: 3, image: '/images/articles/genin-caramel-philosophy.webp', tags: ['карамель', 'соль', 'Guérande', 'терруар'], sourceUrl: 'https://parisbymouth.com/our-guide-to-paris-jacques-genin/', date: '2026-04-20', sourceLabel: 'Paris by Mouth' },
  { id: 'genin-ganache-craft', title: 'Жак Жени и ганаш: шоколад как продукт терруара, а не бренда', excerpt: 'Как Жени выбирает какао-бобы, работает с криолло из Мадагаскара и почему в его ганаше нет лишних ингредиентов.', content: body('Жак Жени ганаш терруар', 'genin-ganache-craft'), category: 'jacques-genin', author: 'Food & Sens, Newtable', readTime: 2, image: '/images/articles/genin-ganache-craft.webp', tags: ['ганаш', 'шоколад', 'терруар', 'криолло'], sourceUrl: 'https://foodandsens.com/made-by-f-and-s/chefs-on-parle-de-vous/jacques-genin-patissier-a-appris-aupres-chefs-de-cuisine/', date: '2026-04-25', sourceLabel: 'Food & Sens' },

  // ── CYRIL LIGNAC ─────────────────────────────────────────────────────────────
  { id: 'lignac-far-breton', title: 'Сириль Линьяк: фар бретон — деревенский десерт с точностью haute pâtisserie', excerpt: 'Учебный разбор фар бретон: соотношение яиц, сливок и муки, сухофрукты, температура и зачем нужен высокий бортик формы.', content: body('Линьяк фар бретон', 'lignac-far-breton'), category: 'cyril-lignac', author: 'Cyril Lignac, Cuisine Actuelle', readTime: 2, image: '/images/articles/lignac-far-breton.webp', tags: ['фар бретон', 'Бретань', 'яйца', 'простота'], sourceUrl: 'https://www.cuisineactuelle.fr/recettes/recettes-de-chefs/far-breton-au-pruneaux-de-cyril-lignac-53044', date: '2026-04-28', sourceLabel: 'Cuisine Actuelle' },
  ...
  // ── CLAIRE HEITZLER ─────────────────────────────────────────────────────────
  { id: 'heitzler-less-sugar', title: 'Клер Эйцлер: меньше сахара — больше вкуса. Как убрать 30% без потери удовольствия', excerpt: 'Практический разбор методологии: чем компенсировать сладость, как работает кислота, и почему горечь — это не враг.', content: body('Эйцлер меньше сахара', 'heitzler-less-sugar'), category: 'claire-heitzler', author: 'Pastry Arts Magazine, Valrhona', readTime: 2, image: '/images/articles/heitzler-less-sugar.webp', tags: ['сахар', 'баланс', 'кислота', 'горечь'], sourceUrl: 'https://www.chefs4impact.org/post/meet-claire-heitzler', date: '2026-04-30', sourceLabel: 'Pastry Arts Magazine' },
  ...
  // ── NICOLAS PACIELLO ─────────────────────────────────────────────────────────
  { id: 'paciello-flan-parisien', title: 'Николя Пачелло: flan parisien — философия простоты и техника без права на ошибку', excerpt: 'Почему главный кондитер Plaza Athénée посвятил парижскому флану отдельную страницу в меню: тесто, крем, температура.', content: body('Пачелло флан парижский', 'paciello-flan-parisien'), category: 'nicolas-paciello', author: 'Frenchefs, Journal des Femmes', readTime: 3, image: '/images/articles/paciello-flan-parisien.webp', tags: ['флан', 'Париж', 'простота', 'Plaza Athénée'], sourceUrl: 'https://frenchefs.fr/nicolas-paciello', date: '2026-05-04', sourceLabel: 'Frenchefs' },
  ...
  { id: 'perret-madeleine', title: 'Мадлен Перре: beurre noisette, лимонная глазурь и Пруст на витрине Ritz', excerpt: 'Технологический разбор самой знаменитой мадлен Парижа: коричневое масло, мёд акации, температурный шок и 7 евро за штуку.', content: body('Перре мадлен', 'perret-madeleine'), category: 'francois-perret', author: 'Ritz Paris, Madame Figaro', readTime: 2, image: '/images/articles/perret-madeleine.webp', tags: ['мадлен', 'beurre noisette', 'Пруст', 'Ritz'], sourceUrl: 'https://www.ritzparislecomptoir.com/en/francois-perret', date: '2025-02-10', sourceLabel: 'Ritz Paris Le Comptoir' },
  ...
  { id: 'recipe-canele', title: 'Канеле де Бордо: медные формы, пчелиный воск и двухэтапная выпечка', excerpt: 'Полная технологическая карта бордоского канеле: выдержка теста 48 часов, температурный шок, почти горелая корочка и заварная середина.', content: body('Канеле Бордо', 'recipe-canele'), category: 'recipes', author: 'Confrérie du Canelé, Baillardran', readTime: 4, image: '/images/articles/recipe-canele.webp', tags: ['канеле', 'Бордо', 'ром', 'медные формы'], sourceUrl: 'https://www.baillardran.com/en/canele', date: '2025-03-10', sourceLabel: 'Baillardran',
    recipeData: {
      prepTime: 'PT48H', cookTime: 'PT1H', yield: '12 канеле (классические медные формы)',
      ingredients: ['Молоко цельное — 500 мл', 'Сливочное масло — 50 г', 'Ваниль (стручок) — 1 шт', 'Яйцо — 1 шт', 'Желтки — 2 шт', 'Сахар — 250 г', 'Мука T55 — 100 г', 'Ром тёмный — 30 мл', 'Пчелиный воск для форм — по необходимости']
    },
    faq: [
      { question: 'Обязательно ли выдерживать тесто 24–48 часов?', answer: 'Да. За это время клейковина расслабляется, мука равномерно увлажняется, ароматы рома и ванили развиваются и интегрируются. Свежее тесто даёт плотный, "хлебный" канеле без характерной кремовой текстуры внутри.' },
      { question: 'Почему корочка не карамелизуется?', answer: 'Либо формы не прогреты до заливки теста, либо температура духовки слишком низкая. Профессиональный режим: 240°C первые 10 минут для корочки, затем снижение до 180°C на 40–50 минут для пропекания середины.' },
      { question: 'Чем заменить медные формы?', answer: 'Силиконовые формы дают мягкую, бледную корочку — канеле теряет свою суть. Стальные формы — компромисс: чуть менее интенсивная корочка, но приемлемо. Медные формы Baillardran — стандарт индустрии.' },
      { question: 'Можно ли готовить без рома?', answer: 'Да, но аромат будет менее выраженным. Замена: ванильный экстракт + цедра апельсина. Традиционный бордоский канеле использует именно ром — это часть аутентичного вкуса.' }
    ]
  },
  ...
  { id: 'recipe-tarte-tatin', title: 'Классический Тарт Татен (Tarte Tatin): Аутентичный французский рецепт с карамелью', excerpt: 'Полная технологическая карта классической тарт Татен: сухой карамель, двухэтапная выпечка, демуляж без потерь. История из Ламотт-Бёврон, которая стала символом французского десерта.', content: body('Тарт Татен', 'recipe-tarte-tatin'), category: 'recipes', author: 'Meilleur du Chef, Confrérie du Tarte Tatin', readTime: 5, image: '/images/articles/recipe-tarte-tatin.webp', tags: ['тарт татен', 'яблоки', 'карамель', 'pâte brisée', 'Солонь'], date: '2026-05-05', sourceUrl: 'https://www.meilleurduchef.com/en/recipe/tarte-tatin-apple.html', sourceLabel: 'Meilleur du Chef',
    recipeData: {
      prepTime: 'PT30M', cookTime: 'PT45M', yield: '6–8 порций (форма ⌀24 см)',
      ingredients: ['Яблоки (Ренет, Кальвиль, Гренни) — 1.2 кг', 'Сахар — 150 г', 'Сливочное масло — 80 г', 'Соль — щепотка', 'Лимонный сок — 1 ст.л.', 'Тесто: мука T55 — 250 г', 'Тесто: сливочное масло (холодное) — 125 г', 'Тесто: вода ледяная — 60 мл', 'Тесто: соль — 5 г']
    },
    faq: [
      { question: 'Почему яблоки превратились в кашу?', answer: 'Сорт яблок слишком мягкий (например, Голден) или время карамелизации было слишком долгим. Используйте плотные сорта: Кальвиль, Ренет, Гренни Смит. Карамелизуйте не более 15–20 минут.' },
      { question: 'Можно ли использовать готовое слоёное тесто?', answer: 'Классический tarte Tatin делается на pâte brisée. Слоёное тесто слишком жирное и не удержит вес яблок — оно раскиснет. Если хотите слоёное — выбирайте pâte feuilletée inversée (инвертированное), оно плотнее.' },
      { question: 'Когда переворачивать тарт?', answer: 'Строго через 5 минут после извлечения из духовки. Слишком горячо — яблоки развалятся. Слишком остыло — карамель схватится и прилипнет к форме. Идеальное окно: 3–5 минут.' },
      { question: 'Нужно ли чистить яблоки?', answer: 'Нет. Кожура помогает яблокам держать форму при длительной карамелизации. Только удалите сердцевину и нарежьте на 4–6 частей. Confrérie du Tarte Tatin официально допускает яблоки с кожурой.' }
    ]
  },

  { id: 'recipe-creme-brulee', title: 'Идеальный Крем-брюле: Классический французский рецепт с ванилью и карамельной корочкой', excerpt: 'Исчерпывающий рецепт классического crème brûlée: 100°C, 55 минут, соотношение 5 желтков на 500 мл сливок, chalumeau и правило 90 секунд до подачи.', content: body('Крем-брюле ваниль', 'recipe-creme-brulee'), category: 'recipes', author: 'Rians, Atelier des Chefs', readTime: 2, image: '/images/articles/recipe-creme-brulee.webp', tags: ['крем-брюле', 'крем брюле', 'crème brûlée', 'brulee', 'ваниль bourbon', 'бань-мари', 'chalumeau', 'желтки'], date: '2026-05-05', sourceUrl: 'https://rians.com/fr/recettes/creme-brulee-la-recette-authentique-rians/', sourceLabel: 'Rians — Recette Authentique',
    recipeData: {
      prepTime: 'PT1H', cookTime: 'PT55M', yield: '4–6 порций',
      ingredients: ['Сливки 30–35% — 500 мл', 'Желтки — 5–6 шт.', 'Сахар — 80–100 г', 'Ваниль (стручок или паста) — 1 шт.', 'Сахар для карамелизации — 1–2 ч.л. на порцию']
    },
    faq: [
      { question: 'Почему на поверхности крема пузыри?', answer: 'Желтки были взбиты слишком активно или массу не процедили через сито перед разливкой. Слегка перемешайте желтки с сахаром — без воздушной пены.' },
      { question: 'Крем получился зернистым. Что делать?', answer: 'Перегрев в духовке или слишком горячие сливки резко попали в желтки. Темперируйте желтки постепенно, цедя массу через мелкое сито.' },
      { question: 'Корочка получилась толстой и горькой.', answer: 'Слишком много сахара или горелку держали слишком долго. Лучше два очень тонких слоя с коротким временем карамелизации.' },
      { question: 'Можно ли готовить заранее?', answer: 'Да. Крем выдерживают в холодильнике минимум 4 часа (лучше ночь). Но карамелизовать нужно непосредственно перед подачей — иначе корочка потянет влагу и станет липкой.' }
    ]
  },
  ...
  { id: 'recipe-clafoutis-cerises', title: 'Клафути с вишней: лимузенский рецепт с kirsch и косточками', excerpt: 'Аутентичный clafoutis aux cerises из Лимузена: почему косточки не вынимают, двухтемпературная выпечка 210→180°C и рецепт Ladurée с цедрой лимона.', content: body('Клафути вишня', 'recipe-clafoutis-cerises'), category: 'recipes', author: 'Académie du Goût (Alain Ducasse), Ladurée Sucré', readTime: 3, image: '/images/articles/recipe-clafoutis-cerises.webp', tags: ['клафути', 'вишня', 'Лимузен', 'kirsch', 'Ladurée'], date: '2026-05-05', sourceUrl: 'https://www.academiedugout.fr/recettes/clafoutis-aux-cerises_10375_2', sourceLabel: 'Académie du Goût — Alain Ducasse',
    recipeData: {
      prepTime: 'PT20M', cookTime: 'PT45M', yield: '6 порций',
      ingredients: ['Вишня (с косточками) — 500 г', 'Яйца — 4 шт', 'Сахар — 120 г', 'Мука T55 — 80 г', 'Молоко — 250 мл', 'Сливки 30% — 100 мл', 'Ваниль (стручок) — 1 шт', 'Сливочное масло (для формы) — 20 г', 'Kirsch — 2 ст.л.', 'Цедра лимона — 1 шт (по версии Ladurée)']
    },
    faq: [
      { question: 'Обязательно ли оставлять косточки?', answer: 'Традиционный лимузенский clafoutis — с косточками. Они дают миндальный аромат и не дают вишне пускать слишком много сока. Если не хотите косточки, добавьте 1 ч.л. миндального экстракта.' },
      { question: 'Тесто слишком жидкое, как блиц-блин, а не flan.', answer: 'Классический clafoutis — это компромисс между flan и clafoutis: текстура должна быть кремовой, но плотной. Если получилось слишком жидко — добавьте ещё 20 г муки и увеличьте время выпечки.' },
      { question: 'Можно ли использовать замороженную вишню?', answer: 'Да, но разморозьте её заранее и слейте сок. Свежая вишня всегда даёт лучший аромат, особенно в сезон (июнь–июль в Северном полушарии).' }
    ]
  },
  ...
  { id: 'recipe-souffle-chocolat', title: 'Шоколадное суфле: физика горба, меренга и правило 90 секунд', excerpt: 'Полный разбор soufflé au chocolat: смазка вертикально, трик chapeau de cuisinier, метод crème pâtissière для ресторанного суфле и почему не надо бояться открывать духовку.', content: body('Шоколадное суфле', 'recipe-souffle-chocolat'), category: 'recipes', author: 'Christophe Michalak, Plaza Athénée technique', readTime: 5, image: '/images/articles/recipe-souffle-chocolat.webp', tags: ['суфле', 'шоколад', 'меренга', 'Valrhona', 'Plaza Athénée'], date: '2026-05-05', sourceUrl: 'https://mypastryclass.com/blogs/articles/', sourceLabel: 'PastryClass',
    recipeData: {
      prepTime: 'PT30M', cookTime: 'PT13M', yield: '4 порции (рамекины 8 см)',
      ingredients: ['Тёмный шоколад 70% — 120 г', 'Сливочное масло — 40 г', 'Молоко — 150 мл', 'Сахар — 50 г', 'Желтки — 3 шт', 'Белки — 4 шт', 'Сахар (для меренги) — 30 г', 'Какао-порошок (по Мишалаку) — 1 ст.л.', 'Сливочное масло и сахар (для рамекинов) — по необходимости']
    },
    faq: [
      { question: 'Суфле не поднялось — что делать?', answer: 'Меренга была недовзбита или база была слишком горячей (>40°C) и убила белки. База должна быть тёплой, но не горячей. Меренга — плотная, блестящая, до «птичьего клюва».' },
      { question: 'Суфле «опало» до подачи стола.', answer: 'Это природа суфле — оно держится только первые 90 секунд. Предупредите гостей заранее или сделайте паузу в подаче других блюд.' },
      { question: 'Зачем смазывать рамекины вертикально (а не горизонтально)?', answer: 'Вертикальная смазка создаёт «лесенку» для подъёма теста — оно цепляется за бороздки и поднимается равномерно. Горизонтальная смазка не даёт сцепления, и суфле «сползает».' },
      { question: 'Можно ли приготовить суфле заранее?', answer: 'Нет — суфле всегда делается по заказу. Можно подготовить базу за 2–3 часа и хранить при комнатной температуре, но меренгу взбивать и собирать суфле только по заказу. Время от заказа до подачи: 14 минут.' }
    ]
  },
  ...
  { id: 'recipe-madeleines', title: 'Мадлен: beurre noisette, температурный шок и горб — техника Ritz Paris', excerpt: 'Пошаговый рецепт мадлен с культовым горбом: охлаждение теста ночь, духовка 210°C, форма холодная. История Пруста, техника Ritz Paris и полная диагностика плоских мадлен.', content: body('Мадлен', 'recipe-madeleines'), category: 'recipes', author: 'François Perret (Ritz Paris), Madame Figaro', readTime: 5, image: '/images/articles/recipe-madeleines.webp', tags: ['мадлен', 'beurre noisette', 'горб', 'Ritz Paris', 'Пруст'], date: '2026-05-05', sourceUrl: 'https://www.ritzparislecomptoir.com/en/francois-perret', sourceLabel: 'Ritz Paris — François Perret',
    recipeData: {
      prepTime: 'PT4H', cookTime: 'PT13M', yield: '12–16 мадлен',
      ingredients: ['Яйца — 2 шт (комнатной температуры)', 'Сахар — 100 г', 'Мёд (акациевый) — 20–30 г', 'Мука T55 — 120 г', 'Разрыхлитель — 4 г', 'Beurre noisette — 100 г', 'Цедра лимона — 1 шт', 'Соль — щепотка']
    },
    faq: [
      { question: 'Почему нет горба?', answer: 'Три условия должны быть выполнены одновременно: тесто холодное (минимум 1 час, лучше ночь), духовка горячая (210–220°C), форма холодная. Любое нарушение — плоская мадлен.' },
      { question: 'Горб есть, но центр сырой.', answer: 'Духовка слишком горячая. Убавьте до 200°C после первых 5 минут формирования горба и добавьте 2 минуты времени выпечки.' },
      { question: 'Мадлен прилипают к форме.', answer: 'Форма смазана недостаточно или неравномерно. Смазывайте каждую ячейку отдельно кисточкой, включая рёбра, и посыпайте мукой, стряхивая лишнее.' },
      { question: 'Когда вынимать из формы?', answer: 'Сразу после выпечки. Если оставить в горячей форме, мадлен «допекутся» и пересохнут. Вынимайте и остужайте на решётке.' }
    ]
  },
  ...
  // ── Chiffres Gourmands ────────────────────────────────────────────────────
  {
    ...
    faq: [
      { question: 'Сколько кондитерских во Франции?', answer: 'По данным CNBPF и INSEE, во Франции работает около 44 000 кондитерских и пекарен-кондитерских (boulangeries-pâtisseries). Из них примерно 35 000 — независимые предприятия.' },
      { question: 'Какой десерт №1 во Франции?', answer: 'По данным IFOP (опрос 2023), 78% французов называют любимым десертом tarte au citron. На втором месте — éclairs au chocolat (62%), на третьем — mille-feuille (47%).' },
      { question: 'Сколько круассанов продаётся ежедневно?', answer: 'Около 12 миллионов штук в день по всей Франции. Это 4,4 миллиарда круассанов в год.' }
    ]
  },
  {
  ...
  },
  {
    ...
    faq: [
      { question: 'Какой самый дорогой десерт в мире?', answer: 'По данным на 2026 год, самые дорогие десерты — это шоу-куски (showpieces) для свадеб и событий. Цена одного шоу-куска может достигать 25 000 €. Например, шоу-кусок Cédric Grolet для парижского события стоил 24 800 €.' },
      { question: 'Почему французские десерты такие дорогие?', answer: 'Высокая маржа (58–74%) обусловлена: ручным трудом (не индустриальная штамповка), коротким сроком хранения (нет экономии на масштабе), премиальными ингредиентами (Valrhona, бурбонская ваниль), и сильным брендом шефа.' },
      { question: 'Растёт ли рынок дорогих десертов?', answer: 'Да, +19% в год по данным Euromonitor. Драйверы: вирусный контент в Instagram, рост люкс-сегмента в Азии, восстановление туризма в Париже.' }
    ]
  },
  {
