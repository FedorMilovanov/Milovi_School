    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed right-4 max-sm:right-1 max-lg:bottom-[calc(5.5rem+env(safe-area-inset-bottom,0px))] lg:bottom-6 z-40 flex h-12 w-12 max-sm:h-11 max-sm:w-11 items-center justify-center rounded-full border border-[var(--border-subtle)] bg-[var(--bg-overlay-95)] text-stone-600 shadow-lg backdrop-blur-sm transition hover:border-stone-400 hover:text-stone-950 active:scale-95 dark:text-stone-400 dark:hover:border-stone-500 dark:hover:text-amber-100"
