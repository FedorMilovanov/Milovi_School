        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-5 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <kbd className="hidden border border-stone-200 px-1 py-0.5 font-mono text-[9px] text-stone-500 dark:border-stone-700 dark:text-stone-400 lg:inline" title="Поиск (Ctrl+K / ⌘K)">⌘K</kbd>
            </motion.button>
            <button
              type="button"
