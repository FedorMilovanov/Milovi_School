      ...
      <div className="px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            ...
            <h2 className="about-h2 max-w-3xl font-serif text-4xl font-semibold leading-[0.95] tracking-[-0.06em] sm:text-6xl">
          ...
          <div className="space-y-6 text-stone-300">
            ...
            <div className="border border-amber-100/15 p-6">
              ...
              <span className="font-serif text-2xl font-semibold text-amber-100">
