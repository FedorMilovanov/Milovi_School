  ...
  return (
    <>
      ...
      <div className="update-notification-root" role="alert" aria-live="polite"
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.875rem 1rem', borderRadius: '0.875rem', background: '#18181b', color: '#fafafa', boxShadow: '0 8px 32px rgba(0,0,0,0.22)', border: '1px solid rgba(217,164,85,0.15)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' }}>
          ...
          <button type="button" onClick={handleUpdate}
            style={{ flexShrink: 0, padding: '0.375rem 0.875rem', borderRadius: '0.25rem', background: '#d9a455', color: '#11100e', fontSize: '0.8125rem', fontWeight: 700, border: 'none', cursor: 'pointer', whiteSpace: 'nowrap', letterSpacing: '0.05em', textTransform: 'uppercase', fontFamily: 'var(--font-mono)' }}
